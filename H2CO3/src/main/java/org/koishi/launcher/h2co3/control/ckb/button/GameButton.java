package org.koishi.launcher.h2co3.control.ckb.button;
...
import org.koishi.launcher.h2co3.control.ckb.achieve.GameButtonDialog;
...
public class GameButton extends AppCompatButton implements View.OnTouchListener {
    ...
    private void initAttribute() {
        ...
        this.setKeyName("");
        this.setButtonMode(mManager.getButtonMode());
    ...
    public boolean onTouch(View v, MotionEvent event) {
        if (v == this) {
            switch (this.buttonMode) {
                ...
                case MODE_PREVIEW, MODE_MOVEABLE_EDITABLE -> editView(event);
            }
            return true;
        }
