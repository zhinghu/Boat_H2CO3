    ...
    *error_ptr = -1; // Reinit error pointer
    ...
    while ((curStatus.status != ST_ERROR) && (curStatus.status != ST_DONE)) {
        ARBCONV_DBG_LP(
                ...
                if (curStatus.valueType == TYPE_INST_DECL) {
                    ...
                    printf("-%15s",
                           curStatus.curValue.newOpt.optName ? curStatus.curValue.newOpt.optName
                                                             : "");
                } else {
                    printf("                ");
                }
        ...
        ARBCONV_DBG(
                ...
                for (size_t i = 0; i < curStatus.variables.size; ++i) {
                    ...
                    printf("Variable %p %10s (%lu): %-10s (init = %3lu %s)\n", varPtr,
                           varPtr->names[0], varPtr->names_count, VARTYPE2STR(varPtr->type),
                           varPtr->init.strings_total_len,
                           varPtr->init.strings_count ? varPtr->init.strings[0] : "(none)");
                }
                printf("\nInstructions:\n=============\n");
                for (size_t i = 0; i < curStatus.instructions.size; ++i) {
                    ...
                    if (INSTTEX(instPtr->type)) {
                        printf("Instruction %3s%4s %c%10s[%2s].%c%c%c%c %c%10s[%2s].%c%c%c%c %ctexture[%2s]      %c%19s\n",
                               ...
                               instPtr->vars[0].sign ? (instPtr->vars[0].sign == -1 ? '-' : '+')
                                                     : ' ',
                               instPtr->vars[0].var ? ((instPtr->vars[0].var->type == VARTYPE_CONST)
                                                       ? instPtr->vars[0].var->init.strings[0]
                                                       : instPtr->vars[0].var->names[0]) : "(none)",
                               instPtr->vars[0].floatArrAddr ? instPtr->vars[0].floatArrAddr : "",
                               (instPtr->vars[0].swizzle[0] == SWIZ_X) ? 'x'
                                                                       : (instPtr->vars[0].swizzle[0] ==
                                                                          SWIZ_Y) ? 'y'
                                                                                  : (instPtr->vars[0].swizzle[0] ==
                                                                                     SWIZ_Z) ? 'z'
                                                                                             : (instPtr->vars[0].swizzle[0] ==
                                                                                               ...
                                                                                               ? 'w'
                                                                                               : ' ',
                               (instPtr->vars[0].swizzle[1] == SWIZ_X) ? 'x'
                                                                       : (instPtr->vars[0].swizzle[1] ==
                                                                          SWIZ_Y) ? 'y'
                                                                                  : (instPtr->vars[0].swizzle[1] ==
                                                                                     SWIZ_Z) ? 'z'
                                                                                             : (instPtr->vars[0].swizzle[1] ==
                                                                                               ...
                                                                                               ? 'w'
                                                                                               : ' ',
                               (instPtr->vars[0].swizzle[2] == SWIZ_X) ? 'x'
                                                                       : (instPtr->vars[0].swizzle[2] ==
                                                                          SWIZ_Y) ? 'y'
                                                                                  : (instPtr->vars[0].swizzle[2] ==
                                                                                     SWIZ_Z) ? 'z'
                                                                                             : (instPtr->vars[0].swizzle[2] ==
                                                                                               ...
                                                                                               ? 'w'
                                                                                               : ' ',
                               (instPtr->vars[0].swizzle[3] == SWIZ_X) ? 'x'
                                                                       : (instPtr->vars[0].swizzle[3] ==
                                                                          SWIZ_Y) ? 'y'
                                                                                  : (instPtr->vars[0].swizzle[3] ==
                                                                                     SWIZ_Z) ? 'z'
                                                                                             : (instPtr->vars[0].swizzle[3] ==
                                                                                               ...
                                                                                               ? 'w'
                                                                                               : ' ',
                               instPtr->vars[1].sign ? (instPtr->vars[1].sign == -1 ? '-' : '+')
                                                     : ' ',
                               instPtr->vars[1].var ? ((instPtr->vars[1].var->type == VARTYPE_CONST)
                                                       ? instPtr->vars[1].var->init.strings[0]
                                                       : instPtr->vars[1].var->names[0]) : "(none)",
                               instPtr->vars[1].floatArrAddr ? instPtr->vars[1].floatArrAddr : "",
                               (instPtr->vars[1].swizzle[0] == SWIZ_X) ? 'x'
                                                                       : (instPtr->vars[1].swizzle[0] ==
                                                                          SWIZ_Y) ? 'y'
                                                                                  : (instPtr->vars[1].swizzle[0] ==
                                                                                     SWIZ_Z) ? 'z'
                                                                                             : (instPtr->vars[1].swizzle[0] ==
                                                                                               ...
                                                                                               ? 'w'
                                                                                               : ' ',
                               (instPtr->vars[1].swizzle[1] == SWIZ_X) ? 'x'
                                                                       : (instPtr->vars[1].swizzle[1] ==
                                                                          SWIZ_Y) ? 'y'
                                                                                  : (instPtr->vars[1].swizzle[1] ==
                                                                                     SWIZ_Z) ? 'z'
                                                                                             : (instPtr->vars[1].swizzle[1] ==
                                                                                               ...
                                                                                               ? 'w'
                                                                                               : ' ',
                               (instPtr->vars[1].swizzle[2] == SWIZ_X) ? 'x'
                                                                       : (instPtr->vars[1].swizzle[2] ==
                                                                          SWIZ_Y) ? 'y'
                                                                                  : (instPtr->vars[1].swizzle[2] ==
                                                                                     SWIZ_Z) ? 'z'
                                                                                             : (instPtr->vars[1].swizzle[2] ==
                                                                                               ...
                                                                                               ? 'w'
                                                                                               : ' ',
                               (instPtr->vars[1].swizzle[3] == SWIZ_X) ? 'x'
                                                                       : (instPtr->vars[1].swizzle[3] ==
                                                                          SWIZ_Y) ? 'y'
                                                                                  : (instPtr->vars[1].swizzle[3] ==
                                                                                     SWIZ_Z) ? 'z'
                                                                                             : (instPtr->vars[1].swizzle[3] ==
                                                                                               ...
                                                                                               ? 'w'
                                                                                               : ' ',
                               instPtr->vars[2].sign ? (instPtr->vars[2].sign == -1 ? '-' : '+')
                                                     : ' ', instPtr->vars[2].var->names[0],
                               instPtr->vars[3].sign ? (instPtr->vars[3].sign == -1 ? '-' : '+')
                                                     : ' ',
                               (instPtr->vars[3].var == curStatus.tex1D) ? "1D"
                                                                         : (instPtr->vars[3].var ==
                                                                            curStatus.tex2D) ? "2D"
                                                                                             : (instPtr->vars[3].var ==
                                                                                                curStatus.tex3D)
                        ...
                        printf("Instruction %3s%4s %c%10s[%2s].%c%c%c%c %c%10s[%2s].%c%c%c%c %c%10s[%2s].%c%c%c%c %c%10s[%2s].%c%c%c%c\n",
                               ...
                               instPtr->vars[2].sign ? (instPtr->vars[2].sign == -1 ? '-' : '+')
                                                     : ' ',
                               instPtr->vars[2].var ? ((instPtr->vars[2].var->type == VARTYPE_CONST)
                                                       ? instPtr->vars[2].var->init.strings[0]
                                                       : instPtr->vars[2].var->names[0]) : "(none)",
                               instPtr->vars[2].floatArrAddr ? instPtr->vars[2].floatArrAddr : "",
                               (instPtr->vars[2].swizzle[0] == SWIZ_X) ? 'x'
                                                                       : (instPtr->vars[2].swizzle[0] ==
                                                                          SWIZ_Y) ? 'y'
                                                                                  : (instPtr->vars[2].swizzle[0] ==
                                                                                     SWIZ_Z) ? 'z'
                                                                                             : (instPtr->vars[2].swizzle[0] ==
                                                                                               ...
                                                                                               ? 'w'
                                                                                               : ' ',
                               (instPtr->vars[2].swizzle[1] == SWIZ_X) ? 'x'
                                                                       : (instPtr->vars[2].swizzle[1] ==
                                                                          SWIZ_Y) ? 'y'
                                                                                  : (instPtr->vars[2].swizzle[1] ==
                                                                                     SWIZ_Z) ? 'z'
                                                                                             : (instPtr->vars[2].swizzle[1] ==
                                                                                               ...
                                                                                               ? 'w'
                                                                                               : ' ',
                               (instPtr->vars[2].swizzle[2] == SWIZ_X) ? 'x'
                                                                       : (instPtr->vars[2].swizzle[2] ==
                                                                          SWIZ_Y) ? 'y'
                                                                                  : (instPtr->vars[2].swizzle[2] ==
                                                                                     SWIZ_Z) ? 'z'
                                                                                             : (instPtr->vars[2].swizzle[2] ==
                                                                                               ...
                                                                                               ? 'w'
                                                                                               : ' ',
                               (instPtr->vars[2].swizzle[3] == SWIZ_X) ? 'x'
                                                                       : (instPtr->vars[2].swizzle[3] ==
                                                                          SWIZ_Y) ? 'y'
                                                                                  : (instPtr->vars[2].swizzle[3] ==
                                                                                     SWIZ_Z) ? 'z'
                                                                                             : (instPtr->vars[2].swizzle[3] ==
                               ...
                               instPtr->vars[3].sign ? (instPtr->vars[3].sign == -1 ? '-' : '+')
                                                     : ' ',
                               instPtr->vars[3].var ? ((instPtr->vars[3].var->type == VARTYPE_CONST)
                                                       ? instPtr->vars[3].var->init.strings[0]
                                                       : instPtr->vars[3].var->names[0]) : "(none)",
                               instPtr->vars[3].floatArrAddr ? instPtr->vars[3].floatArrAddr : "",
                               (instPtr->vars[3].swizzle[0] == SWIZ_X) ? 'x'
                                                                       : (instPtr->vars[3].swizzle[0] ==
                                                                          SWIZ_Y) ? 'y'
                                                                                  : (instPtr->vars[3].swizzle[0] ==
                                                                                     SWIZ_Z) ? 'z'
                                                                                             : (instPtr->vars[3].swizzle[0] ==
                                                                                               ...
                                                                                               ? 'w'
                                                                                               : ' ',
                               (instPtr->vars[3].swizzle[1] == SWIZ_X) ? 'x'
                                                                       : (instPtr->vars[3].swizzle[1] ==
                                                                          SWIZ_Y) ? 'y'
                                                                                  : (instPtr->vars[3].swizzle[1] ==
                                                                                     SWIZ_Z) ? 'z'
                                                                                             : (instPtr->vars[3].swizzle[1] ==
                                                                                               ...
                                                                                               ? 'w'
                                                                                               : ' ',
                               (instPtr->vars[3].swizzle[2] == SWIZ_X) ? 'x'
                                                                       : (instPtr->vars[3].swizzle[2] ==
                                                                          SWIZ_Y) ? 'y'
                                                                                  : (instPtr->vars[3].swizzle[2] ==
                                                                                     SWIZ_Z) ? 'z'
                                                                                             : (instPtr->vars[3].swizzle[2] ==
                                                                                               ...
                                                                                               ? 'w'
                                                                                               : ' ',
                               (instPtr->vars[3].swizzle[3] == SWIZ_X) ? 'x'
                                                                       : (instPtr->vars[3].swizzle[3] ==
                                                                          SWIZ_Y) ? 'y'
                                                                                  : (instPtr->vars[3].swizzle[3] ==
                                                                                     SWIZ_Z) ? 'z'
                                                                                             : (instPtr->vars[3].swizzle[3] ==
    ...
    do {
        ...
        for (; (varIdx < curStatus.variables.size) && (curStatus.status != ST_ERROR); ++varIdx) {
            ...
            ARBCONV_DBG_AS(
                    printf("Variable #%2ld: %10s (%10s)\n", varIdx, varPtr->names[0],
                           VARTYPE2STR(varPtr->type));
                    fflush(stdout);
            )
        ...
        APPEND_OUTPUT("\t\n", 2)
        for (; (instIdx < curStatus.instructions.size) &&
               (curStatus.status != ST_ERROR); ++instIdx) {
            ...
            ARBCONV_DBG_AS(
                    if (INSTTEX(instPtr->type)) {
                        printf("Instruction #%3ld: %3s%4s %c%10s[%2s].%c%c%c%c %c%10s[%2s].%c%c%c%c %ctexture[%2s]      %c%19s\n",
                               instIdx, INST2STR(instPtr->type),
                               instPtr->saturated ? "_SAT" : "    ",
                               instPtr->vars[0].sign ? (instPtr->vars[0].sign == -1 ? '-' : '+')
                                                     : ' ',
                               instPtr->vars[0].var ? ((instPtr->vars[0].var->type == VARTYPE_CONST)
                                                       ? instPtr->vars[0].var->init.strings[0]
        ...
        APPEND_OUTPUT("\t\n", 2)
        for (varIdx = 0;
             (varIdx < curStatus.variables.size) && (curStatus.status != ST_ERROR); ++varIdx) {
            varPtr = curStatus.variables.vars[varIdx];
        ...
        ARBCONV_DBG(printf("Failure!\n");
                            ...
                            for (size_t i = 0; i < curStatus.variables.size; ++i) {
                                ...
                                printf("%sVariable %p %10s (%lu): %-10s (init = %3lu %s)\033[m\n",
                                       (i < varIdx) ? "" : "\033[91m", varPtr, varPtr->names[0],
                                       varPtr->names_count, VARTYPE2STR(varPtr->type),
                                       varPtr->init.strings_total_len,
                                       varPtr->init.strings_count ? varPtr->init.strings[0]
                                                                  : "(none)");
                            }
                            printf("\nInstructions:\n=============\n");
                            for (size_t i = 0; i < curStatus.instructions.size; ++i) {
                                ...
                                if (INSTTEX(instPtr->type)) {
                                    printf("%sInstruction %3s%4s %c%10s[%2s].%c%c%c%c %c%10s[%2s].%c%c%c%c %ctexture[%2s]      %c%19s\033[m\n",
                                           (i < instIdx) ? "" : "\033[91m", INST2STR(instPtr->type),
                                           instPtr->saturated ? "_SAT" : "    ",
                                           instPtr->vars[0].sign ? (instPtr->vars[0].sign == -1
                                                                    ? '-' : '+') : ' ',
                                           instPtr->vars[0].var ? ((instPtr->vars[0].var->type ==
                                                                    VARTYPE_CONST)
                                                                   ? instPtr->vars[0].var->init.strings[0]
                                                                   : instPtr->vars[0].var->names[0])
                                                                : "(none)",
                                           instPtr->vars[0].floatArrAddr
                                           ? instPtr->vars[0].floatArrAddr : "",
                                           (instPtr->vars[0].swizzle[0] == SWIZ_X) ? 'x'
                                                                                   : (instPtr->vars[0].swizzle[0] ==
                                                                                      SWIZ_Y) ? 'y'
                                           ...
                                           instPtr->vars[1].sign ? (instPtr->vars[1].sign == -1
                                                                    ? '-' : '+') : ' ',
                                           instPtr->vars[1].var ? ((instPtr->vars[1].var->type ==
                                                                    VARTYPE_CONST)
                                                                   ? instPtr->vars[1].var->init.strings[0]
                                                                   : instPtr->vars[1].var->names[0])
                                                                : "(none)",
                                           instPtr->vars[1].floatArrAddr
                                           ? instPtr->vars[1].floatArrAddr : "",
                                           (instPtr->vars[1].swizzle[0] == SWIZ_X) ? 'x'
                                                                                   : (instPtr->vars[1].swizzle[0] ==
                                                                                      SWIZ_Y) ? 'y'
                                    ...
                                    printf("%sInstruction %3s%4s %c%10s[%2s].%c%c%c%c %c%10s[%2s].%c%c%c%c %c%10s[%2s].%c%c%c%c %c%10s[%2s].%c%c%c%c\033[m\n",
                                           ...
                                           instPtr->vars[2].sign ? (instPtr->vars[2].sign == -1
                                                                    ? '-' : '+') : ' ',
                                           instPtr->vars[2].var ? ((instPtr->vars[2].var->type ==
                                                                    VARTYPE_CONST)
                                                                   ? instPtr->vars[2].var->init.strings[0]
                                                                   : instPtr->vars[2].var->names[0])
                                                                : "(none)",
                                           instPtr->vars[2].floatArrAddr
                                           ? instPtr->vars[2].floatArrAddr : "",
                                           (instPtr->vars[2].swizzle[0] == SWIZ_X) ? 'x'
                                                                                   : (instPtr->vars[2].swizzle[0] ==
                                                                                      SWIZ_Y) ? 'y'
                                           ...
                                           instPtr->vars[3].sign ? (instPtr->vars[3].sign == -1
                                                                    ? '-' : '+') : ' ',
                                           instPtr->vars[3].var ? ((instPtr->vars[3].var->type ==
                                                                    VARTYPE_CONST)
                                                                   ? instPtr->vars[3].var->init.strings[0]
                                                                   : instPtr->vars[3].var->names[0])
                                                                : "(none)",
                                           instPtr->vars[3].floatArrAddr
                                           ? instPtr->vars[3].floatArrAddr : "",
                                           (instPtr->vars[3].swizzle[0] == SWIZ_X) ? 'x'
                                                                                   : (instPtr->vars[3].swizzle[0] ==
                                                                                      SWIZ_Y) ? 'y'
