...
static inline map_state_t **get_map_pointer(GLenum target) {
    switch (target) {
        case GL_MAP1_COLOR_4:
            return &glstate->map1.color4;
        case GL_MAP1_INDEX:
            return &glstate->map1.index;
        case GL_MAP1_TEXTURE_COORD_1:
            return &glstate->map1.texture1;
        case GL_MAP1_TEXTURE_COORD_2:
            return &glstate->map1.texture2;
        case GL_MAP1_TEXTURE_COORD_3:
            return &glstate->map1.texture3;
        case GL_MAP1_TEXTURE_COORD_4:
            return &glstate->map1.texture4;
        case GL_MAP1_VERTEX_3:
            return &glstate->map1.vertex3;
        case GL_MAP1_VERTEX_4:
            return &glstate->map1.vertex4;
        case GL_MAP2_COLOR_4:
            return &glstate->map2.color4;
        case GL_MAP2_INDEX:
            return &glstate->map2.index;
        case GL_MAP2_TEXTURE_COORD_1:
            return &glstate->map2.texture1;
        case GL_MAP2_TEXTURE_COORD_2:
            return &glstate->map2.texture2;
        case GL_MAP2_TEXTURE_COORD_3:
            return &glstate->map2.texture3;
        case GL_MAP2_TEXTURE_COORD_4:
            return &glstate->map2.texture4;
        case GL_MAP2_VERTEX_3:
            return &glstate->map2.vertex3;
        case GL_MAP2_VERTEX_4:
            return &glstate->map2.vertex4;
        default:
...
void gl4es_glEvalCoord1f(GLfloat u) {
    ...
    iter_maps(1,
              GLfloat uu = (u - map->u._1) * map->u.d;
                      _math_horner_bezier_curve((GLfloat *) map->points, out, uu, map->width,
                                                map->u.order);
    )
}
...
void gl4es_glMapGrid2f(GLint un, GLfloat u1, GLfloat u2,
    ...
    glstate->map_grid[0]._1 = u1;
    glstate->map_grid[0]._2 = u2;
    glstate->map_grid[0].d =
            (glstate->map_grid[0]._2 - glstate->map_grid[0]._1) / glstate->map_grid[0].n;
    glstate->map_grid[1].n = vn;
    glstate->map_grid[1]._1 = v1;
    glstate->map_grid[1]._2 = v2;
    glstate->map_grid[1].d =
            (glstate->map_grid[1]._2 - glstate->map_grid[1]._1) / glstate->map_grid[1].n;
}
...
void gl4es_glEvalPoint2(GLint i, GLint j) {
    gl4es_glEvalCoord2f(glstate->map_grid[0]._1 + glstate->map_grid[0].d * i,
                        glstate->map_grid[1]._1 + glstate->map_grid[1].d * j);
}
...
void glMap1d(GLenum target, GLdouble u1, GLdouble u2, GLint stride, GLint order,
             const GLdouble *points) AliasExport("gl4es_glMap1d");

void glMap1f(GLenum target, GLfloat u1, GLfloat u2, GLint stride, GLint order,
             const GLfloat *points) AliasExport("gl4es_glMap1f");

void glMap2d(GLenum target, GLdouble u1, GLdouble u2, GLint ustride, GLint uorder, GLdouble v1,
             GLdouble v2, GLint vstride, GLint vorder, const GLdouble *points) AliasExport(
        "gl4es_glMap2d");
...
void
glEvalMesh2(GLenum mode, GLint i1, GLint i2, GLint j1, GLint j2) AliasExport("gl4es_glEvalMesh2");
...
void glMapGrid2f(GLint un, GLfloat u1, GLfloat u2, GLint vn, GLfloat v1, GLfloat v2) AliasExport(
        "gl4es_glMapGrid2f");
