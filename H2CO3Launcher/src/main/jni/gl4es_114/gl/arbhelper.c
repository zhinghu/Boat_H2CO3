...
eVariableType STR2VARTYPE(char *str) {
    return
            TST_STR_VAL_PREF(str, VARTYPE_, ADDRESS) TST_STR_VAL_PREF(str, VARTYPE_, ATTRIB)
                                                     TST_STR_VAL_PREF(str, VARTYPE_,
                                                                      PARAM) TST_STR_VAL_PREF(str,
                                                                                              VARTYPE_,
                                                                                              TEMP)
                                                                             TST_STR_VAL_PREF(str,
                                                                                              VARTYPE_,
                                                                                              ALIAS) TST_STR_VAL_PREF(
                                                                                                             str,
                                                                                                             VARTYPE_,
                                                                                                             OUTPUT)
                                                                                                     VARTYPE_UNK;
...
int appendString(sCurStatus *curStatusPtr, const char *str, size_t strLen) {
    ...
    if (curStatusPtr->outLeft < strLen) {
        ...
        while (curStatusPtr->outLeft < strLen) {
            ...
            if (!resize((void **) &curStatusPtr->outputString, &curStatusPtr->outCap,
                        sizeof(char))) {
                return 1;
            }
        }
    ...
    ARBCONV_DBG_HEAVY(ARBCONV_DBG(
                              char *dup = malloc((strLen + 1) * sizeof(char)); memcpy(dup, str,
                                                                                      strLen); dup[strLen] = '\0'; printf(
