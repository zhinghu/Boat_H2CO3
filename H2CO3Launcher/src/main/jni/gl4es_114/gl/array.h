...
GLvoid *copy_gl_pointer_color_bgra(const void *ptr, GLint stride, GLsizei width, GLsizei skip,
                                   GLsizei count);
...
void copy_gl_pointer_noalloc(void *dest, vertexattrib_t *ptr, GLsizei width, GLsizei skip,
                             GLsizei count);

void copy_gl_pointer_color_noalloc(void *dest, vertexattrib_t *ptr, GLsizei width, GLsizei skip,
                                   GLsizei count);

void copy_gl_pointer_color_bgra_noalloc(void *dest, const void *ptr, GLint stride, GLsizei width,
                                        GLsizei skip, GLsizei count);

void copy_gl_pointer_bytecolor_noalloc(void *dest, vertexattrib_t *ptr, GLsizei width, GLsizei skip,
                                       GLsizei count);

void copy_gl_pointer_raw_noalloc(void *dest, vertexattrib_t *ptr, GLsizei width, GLsizei skip,
                                 GLsizei count);

void copy_gl_pointer_tex_noalloc(void *dest, vertexattrib_t *ptr, GLsizei width, GLsizei skip,
                                 GLsizei count);
...
GLfloat *copy_eval_double2(GLenum target, GLint ustride, GLint uorder, GLint vstride, GLint vorder,
                           const GLdouble *points);

GLfloat *copy_eval_float2(GLenum target, GLint ustride, GLint uorder, GLint vstride, GLint vorder,
