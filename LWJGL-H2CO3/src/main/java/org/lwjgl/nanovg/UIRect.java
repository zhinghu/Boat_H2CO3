...
public class UIRect extends Struct<UIRect> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<UIRect, Buffer> implements NativeResource {
        ...
        /** Copies the specified {@link IntBuffer} to the {@code v} field. */
        public Buffer v(@NativeType("int[4]") IntBuffer value) { UIRect.nv(address(), value); return this; }
        /** Sets the specified value at the specified index of the {@code v} field. */
        public Buffer v(int index, int value) { UIRect.nv(address(), index, value); return this; }
        /** Sets the specified value to the {@code x} field. */
        public Buffer x(int value) { UIRect.nx(address(), value); return this; }
        /** Sets the specified value to the {@code y} field. */
        public Buffer y(int value) { UIRect.ny(address(), value); return this; }
        /** Sets the specified value to the {@code w} field. */
        public Buffer w(int value) { UIRect.nw(address(), value); return this; }
        /** Sets the specified value to the {@code h} field. */
        public Buffer h(int value) { UIRect.nh(address(), value); return this; }
