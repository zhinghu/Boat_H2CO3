...
public class XAnyEvent extends Struct<XAnyEvent> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XAnyEvent, Buffer> implements NativeResource {
        ...
        public Buffer type(int value) { XAnyEvent.ntype(address(), value); return this; }
        /** Sets the specified value to the {@link XAnyEvent#serial} field. */
        public Buffer serial(@NativeType("unsigned long") long value) { XAnyEvent.nserial(address(), value); return this; }
        /** Sets the specified value to the {@link XAnyEvent#send_event} field. */
        public Buffer send_event(@NativeType("Bool") boolean value) { XAnyEvent.nsend_event(address(), value ? 1 : 0); return this; }
        /** Sets the specified value to the {@link XAnyEvent#display} field. */
        public Buffer display(@NativeType("Display *") long value) { XAnyEvent.ndisplay(address(), value); return this; }
        /** Sets the specified value to the {@link XAnyEvent#window} field. */
        public Buffer window(@NativeType("Window") long value) { XAnyEvent.nwindow(address(), value); return this; }
