...
public class XPropertyEvent extends Struct<XPropertyEvent> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XPropertyEvent, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(int value) { XPropertyEvent.ntype(address(), value); return this; }
        /** Sets the specified value to the {@link XPropertyEvent#serial} field. */
        public Buffer serial(@NativeType("unsigned long") long value) { XPropertyEvent.nserial(address(), value); return this; }
        /** Sets the specified value to the {@link XPropertyEvent#send_event} field. */
        public Buffer send_event(@NativeType("Bool") boolean value) { XPropertyEvent.nsend_event(address(), value ? 1 : 0); return this; }
        /** Sets the specified value to the {@link XPropertyEvent#display} field. */
        public Buffer display(@NativeType("Display *") long value) { XPropertyEvent.ndisplay(address(), value); return this; }
        /** Sets the specified value to the {@link XPropertyEvent#window} field. */
        public Buffer window(@NativeType("Window") long value) { XPropertyEvent.nwindow(address(), value); return this; }
        /** Sets the specified value to the {@code atom} field. */
