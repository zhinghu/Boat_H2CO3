...
public class XResizeRequestEvent extends Struct<XResizeRequestEvent> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XResizeRequestEvent, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(int value) { XResizeRequestEvent.ntype(address(), value); return this; }
        /** Sets the specified value to the {@link XResizeRequestEvent#serial} field. */
        public Buffer serial(@NativeType("unsigned long") long value) { XResizeRequestEvent.nserial(address(), value); return this; }
        /** Sets the specified value to the {@link XResizeRequestEvent#send_event} field. */
        public Buffer send_event(@NativeType("Bool") boolean value) { XResizeRequestEvent.nsend_event(address(), value ? 1 : 0); return this; }
        /** Sets the specified value to the {@link XResizeRequestEvent#display} field. */
        public Buffer display(@NativeType("Display *") long value) { XResizeRequestEvent.ndisplay(address(), value); return this; }
        /** Sets the specified value to the {@link XResizeRequestEvent#window} field. */
        public Buffer window(@NativeType("Window") long value) { XResizeRequestEvent.nwindow(address(), value); return this; }
        /** Sets the specified value to the {@code width} field. */
        public Buffer width(int value) { XResizeRequestEvent.nwidth(address(), value); return this; }
        /** Sets the specified value to the {@code height} field. */
        public Buffer height(int value) { XResizeRequestEvent.nheight(address(), value); return this; }
