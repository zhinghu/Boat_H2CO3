...
public class XMapRequestEvent extends Struct<XMapRequestEvent> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XMapRequestEvent, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(int value) { XMapRequestEvent.ntype(address(), value); return this; }
        /** Sets the specified value to the {@link XMapRequestEvent#serial} field. */
        public Buffer serial(@NativeType("unsigned long") long value) { XMapRequestEvent.nserial(address(), value); return this; }
        /** Sets the specified value to the {@link XMapRequestEvent#send_event} field. */
        public Buffer send_event(@NativeType("Bool") boolean value) { XMapRequestEvent.nsend_event(address(), value ? 1 : 0); return this; }
        /** Sets the specified value to the {@link XMapRequestEvent#display} field. */
        public Buffer display(@NativeType("Display *") long value) { XMapRequestEvent.ndisplay(address(), value); return this; }
        /** Sets the specified value to the {@code parent} field. */
        public Buffer parent(@NativeType("Window") long value) { XMapRequestEvent.nparent(address(), value); return this; }
        /** Sets the specified value to the {@code window} field. */
        public Buffer window(@NativeType("Window") long value) { XMapRequestEvent.nwindow(address(), value); return this; }
