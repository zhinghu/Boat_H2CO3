...
public class Msghdr extends Struct<Msghdr> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<Msghdr, Buffer> implements NativeResource {
        ...
        public Buffer msg_name(@NativeType("void *") ByteBuffer value) { Msghdr.nmsg_name(address(), value); return this; }
        /** Sets the address of the specified {@link IOVec.Buffer} to the {@link Msghdr#msg_iov} field. */
        public Buffer msg_iov(@NativeType("struct iovec *") IOVec.Buffer value) { Msghdr.nmsg_iov(address(), value); return this; }
        /** Sets the address of the specified {@link ByteBuffer} to the {@link Msghdr#msg_control} field. */
        public Buffer msg_control(@NativeType("void *") ByteBuffer value) { Msghdr.nmsg_control(address(), value); return this; }
        /** Sets the specified value to the {@link Msghdr#msg_flags} field. */
        public Buffer msg_flags(int value) { Msghdr.nmsg_flags(address(), value); return this; }
