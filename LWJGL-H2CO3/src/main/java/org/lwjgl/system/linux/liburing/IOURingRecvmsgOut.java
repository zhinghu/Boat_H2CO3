...
public class IOURingRecvmsgOut extends Struct<IOURingRecvmsgOut> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<IOURingRecvmsgOut, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code namelen} field. */
        public Buffer namelen(@NativeType("__u32") int value) { IOURingRecvmsgOut.nnamelen(address(), value); return this; }
        /** Sets the specified value to the {@code controllen} field. */
        public Buffer controllen(@NativeType("__u32") int value) { IOURingRecvmsgOut.ncontrollen(address(), value); return this; }
        /** Sets the specified value to the {@code payloadlen} field. */
        public Buffer payloadlen(@NativeType("__u32") int value) { IOURingRecvmsgOut.npayloadlen(address(), value); return this; }
        /** Sets the specified value to the {@code flags} field. */
        public Buffer flags(@NativeType("__u32") int value) { IOURingRecvmsgOut.nflags(address(), value); return this; }
