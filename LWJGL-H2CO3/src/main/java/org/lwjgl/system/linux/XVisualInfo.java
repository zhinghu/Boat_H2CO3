...
public class XVisualInfo extends Struct<XVisualInfo> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XVisualInfo, Buffer> implements NativeResource {
        ...
        /** Sets the address of the specified {@link Visual} to the {@code visual} field. */
        public Buffer visual(@NativeType("Visual *") Visual value) { XVisualInfo.nvisual(address(), value); return this; }
        /** Sets the specified value to the {@code visualid} field. */
        public Buffer visualid(@NativeType("VisualID") long value) { XVisualInfo.nvisualid(address(), value); return this; }
        /** Sets the specified value to the {@code screen} field. */
        public Buffer screen(int value) { XVisualInfo.nscreen(address(), value); return this; }
        /** Sets the specified value to the {@code depth} field. */
        public Buffer depth(int value) { XVisualInfo.ndepth(address(), value); return this; }
        /** Sets the specified value to the {@code class} field. */
        public Buffer class$(int value) { XVisualInfo.nclass$(address(), value); return this; }
        /** Sets the specified value to the {@code red_mask} field. */
        public Buffer red_mask(@NativeType("unsigned long") long value) { XVisualInfo.nred_mask(address(), value); return this; }
        /** Sets the specified value to the {@code green_mask} field. */
        public Buffer green_mask(@NativeType("unsigned long") long value) { XVisualInfo.ngreen_mask(address(), value); return this; }
        /** Sets the specified value to the {@code blue_mask} field. */
