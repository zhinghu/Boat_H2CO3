...
public class IOURingRSRCUpdate2 extends Struct<IOURingRSRCUpdate2> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<IOURingRSRCUpdate2, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code offset} field. */
        public Buffer offset(@NativeType("__u32") int value) { IOURingRSRCUpdate2.noffset(address(), value); return this; }
        /** Sets the specified value to the {@code resv} field. */
        public Buffer resv(@NativeType("__u32") int value) { IOURingRSRCUpdate2.nresv(address(), value); return this; }
        /** Sets the specified value to the {@code data} field. */
        public Buffer data(@NativeType("__u64") long value) { IOURingRSRCUpdate2.ndata(address(), value); return this; }
        /** Sets the specified value to the {@code tags} field. */
        public Buffer tags(@NativeType("__u64") long value) { IOURingRSRCUpdate2.ntags(address(), value); return this; }
        /** Sets the specified value to the {@code nr} field. */
        public Buffer nr(@NativeType("__u32") int value) { IOURingRSRCUpdate2.nnr(address(), value); return this; }
        /** Sets the specified value to the {@code resv2} field. */
        public Buffer resv2(@NativeType("__u32") int value) { IOURingRSRCUpdate2.nresv2(address(), value); return this; }
