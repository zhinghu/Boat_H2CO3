...
public class IOURingRSRCRegister extends Struct<IOURingRSRCRegister> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<IOURingRSRCRegister, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code nr} field. */
        public Buffer nr(@NativeType("__u32") int value) { IOURingRSRCRegister.nnr(address(), value); return this; }
        /** Sets the specified value to the {@code flags} field. */
        public Buffer flags(@NativeType("__u32") int value) { IOURingRSRCRegister.nflags(address(), value); return this; }
        /** Sets the specified value to the {@code resv2} field. */
        public Buffer resv2(@NativeType("__u64") long value) { IOURingRSRCRegister.nresv2(address(), value); return this; }
        /** Sets the specified value to the {@code data} field. */
        public Buffer data(@NativeType("__u64") long value) { IOURingRSRCRegister.ndata(address(), value); return this; }
        /** Sets the specified value to the {@code tags} field. */
        public Buffer tags(@NativeType("__u64") long value) { IOURingRSRCRegister.ntags(address(), value); return this; }
