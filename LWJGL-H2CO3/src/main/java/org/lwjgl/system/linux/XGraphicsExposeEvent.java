...
public class XGraphicsExposeEvent extends Struct<XGraphicsExposeEvent> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XGraphicsExposeEvent, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(int value) { XGraphicsExposeEvent.ntype(address(), value); return this; }
        /** Sets the specified value to the {@link XGraphicsExposeEvent#serial} field. */
        public Buffer serial(@NativeType("unsigned long") long value) { XGraphicsExposeEvent.nserial(address(), value); return this; }
        /** Sets the specified value to the {@link XGraphicsExposeEvent#send_event} field. */
        public Buffer send_event(@NativeType("Bool") boolean value) { XGraphicsExposeEvent.nsend_event(address(), value ? 1 : 0); return this; }
        /** Sets the specified value to the {@link XGraphicsExposeEvent#display} field. */
        public Buffer display(@NativeType("Display *") long value) { XGraphicsExposeEvent.ndisplay(address(), value); return this; }
        /** Sets the specified value to the {@code drawable} field. */
        public Buffer drawable(@NativeType("Drawable") long value) { XGraphicsExposeEvent.ndrawable(address(), value); return this; }
        /** Sets the specified value to the {@code x} field. */
        public Buffer x(int value) { XGraphicsExposeEvent.nx(address(), value); return this; }
        /** Sets the specified value to the {@code y} field. */
        public Buffer y(int value) { XGraphicsExposeEvent.ny(address(), value); return this; }
        /** Sets the specified value to the {@code width} field. */
        public Buffer width(int value) { XGraphicsExposeEvent.nwidth(address(), value); return this; }
        /** Sets the specified value to the {@code height} field. */
        public Buffer height(int value) { XGraphicsExposeEvent.nheight(address(), value); return this; }
        /** Sets the specified value to the {@link XGraphicsExposeEvent#count} field. */
        public Buffer count(int value) { XGraphicsExposeEvent.ncount(address(), value); return this; }
        /** Sets the specified value to the {@link XGraphicsExposeEvent#major_code} field. */
        public Buffer major_code(int value) { XGraphicsExposeEvent.nmajor_code(address(), value); return this; }
        /** Sets the specified value to the {@link XGraphicsExposeEvent#minor_code} field. */
        public Buffer minor_code(int value) { XGraphicsExposeEvent.nminor_code(address(), value); return this; }
