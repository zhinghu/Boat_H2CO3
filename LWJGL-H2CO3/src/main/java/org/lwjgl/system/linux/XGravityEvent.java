...
public class XGravityEvent extends Struct<XGravityEvent> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XGravityEvent, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(int value) { XGravityEvent.ntype(address(), value); return this; }
        /** Sets the specified value to the {@link XGravityEvent#serial} field. */
        public Buffer serial(@NativeType("unsigned long") long value) { XGravityEvent.nserial(address(), value); return this; }
        /** Sets the specified value to the {@link XGravityEvent#send_event} field. */
        public Buffer send_event(@NativeType("Bool") boolean value) { XGravityEvent.nsend_event(address(), value ? 1 : 0); return this; }
        /** Sets the specified value to the {@link XGravityEvent#display} field. */
        public Buffer display(@NativeType("Display *") long value) { XGravityEvent.ndisplay(address(), value); return this; }
        /** Sets the specified value to the {@code event} field. */
        public Buffer event(@NativeType("Window") long value) { XGravityEvent.nevent(address(), value); return this; }
        /** Sets the specified value to the {@code window} field. */
