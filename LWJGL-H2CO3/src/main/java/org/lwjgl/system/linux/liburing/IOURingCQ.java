...
public class IOURingCQ extends Struct<IOURingCQ> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<IOURingCQ, Buffer> implements NativeResource {
        ...
        /** Sets the address of the specified {@link IntBuffer} to the {@code khead} field. */
        public Buffer khead(@NativeType("unsigned *") IntBuffer value) { IOURingCQ.nkhead(address(), value); return this; }
        /** Sets the address of the specified {@link IntBuffer} to the {@code ktail} field. */
        public Buffer ktail(@NativeType("unsigned *") IntBuffer value) { IOURingCQ.nktail(address(), value); return this; }
        /** Sets the address of the specified {@link IntBuffer} to the {@link IOURingCQ#kring_mask} field. */
        public Buffer kring_mask(@NativeType("unsigned *") IntBuffer value) { IOURingCQ.nkring_mask(address(), value); return this; }
        /** Sets the address of the specified {@link IntBuffer} to the {@link IOURingCQ#kring_entries} field. */
        public Buffer kring_entries(@NativeType("unsigned *") IntBuffer value) { IOURingCQ.nkring_entries(address(), value); return this; }
        /** Sets the address of the specified {@link IntBuffer} to the {@code kflags} field. */
        public Buffer kflags(@NativeType("unsigned *") IntBuffer value) { IOURingCQ.nkflags(address(), value); return this; }
        /** Sets the address of the specified {@link IntBuffer} to the {@code koverflow} field. */
        public Buffer koverflow(@NativeType("unsigned *") IntBuffer value) { IOURingCQ.nkoverflow(address(), value); return this; }
        /** Sets the address of the specified {@link IOURingCQE} to the {@code cqes} field. */
        public Buffer cqes(@NativeType("struct io_uring_cqe *") IOURingCQE value) { IOURingCQ.ncqes(address(), value); return this; }
        /** Sets the address of the specified {@link ByteBuffer} to the {@code ring_ptr} field. */
        public Buffer ring_ptr(@NativeType("void *") ByteBuffer value) { IOURingCQ.nring_ptr(address(), value); return this; }
        /** Sets the specified value to the {@code ring_mask} field. */
        public Buffer ring_mask(@NativeType("unsigned") int value) { IOURingCQ.nring_mask(address(), value); return this; }
        /** Sets the specified value to the {@code ring_entries} field. */
        public Buffer ring_entries(@NativeType("unsigned") int value) { IOURingCQ.nring_entries(address(), value); return this; }
