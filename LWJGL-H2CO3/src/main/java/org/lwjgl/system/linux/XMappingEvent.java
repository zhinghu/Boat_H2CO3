...
public class XMappingEvent extends Struct<XMappingEvent> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XMappingEvent, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(int value) { XMappingEvent.ntype(address(), value); return this; }
        /** Sets the specified value to the {@link XMappingEvent#serial} field. */
        public Buffer serial(@NativeType("unsigned long") long value) { XMappingEvent.nserial(address(), value); return this; }
        /** Sets the specified value to the {@link XMappingEvent#send_event} field. */
        public Buffer send_event(@NativeType("Bool") boolean value) { XMappingEvent.nsend_event(address(), value ? 1 : 0); return this; }
        /** Sets the specified value to the {@link XMappingEvent#display} field. */
        public Buffer display(@NativeType("Display *") long value) { XMappingEvent.ndisplay(address(), value); return this; }
        /** Sets the specified value to the {@link XMappingEvent#window} field. */
        public Buffer window(@NativeType("Window") long value) { XMappingEvent.nwindow(address(), value); return this; }
