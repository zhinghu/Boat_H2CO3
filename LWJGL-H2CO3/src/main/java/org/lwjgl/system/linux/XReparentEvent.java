...
public class XReparentEvent extends Struct<XReparentEvent> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XReparentEvent, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(int value) { XReparentEvent.ntype(address(), value); return this; }
        /** Sets the specified value to the {@link XReparentEvent#serial} field. */
        public Buffer serial(@NativeType("unsigned long") long value) { XReparentEvent.nserial(address(), value); return this; }
        /** Sets the specified value to the {@link XReparentEvent#send_event} field. */
        public Buffer send_event(@NativeType("Bool") boolean value) { XReparentEvent.nsend_event(address(), value ? 1 : 0); return this; }
        /** Sets the specified value to the {@link XReparentEvent#display} field. */
        public Buffer display(@NativeType("Display *") long value) { XReparentEvent.ndisplay(address(), value); return this; }
        /** Sets the specified value to the {@code event} field. */
        public Buffer event(@NativeType("Window") long value) { XReparentEvent.nevent(address(), value); return this; }
        /** Sets the specified value to the {@code window} field. */
        public Buffer window(@NativeType("Window") long value) { XReparentEvent.nwindow(address(), value); return this; }
        /** Sets the specified value to the {@code parent} field. */
        public Buffer parent(@NativeType("Window") long value) { XReparentEvent.nparent(address(), value); return this; }
        /** Sets the specified value to the {@code x} field. */
        public Buffer x(int value) { XReparentEvent.nx(address(), value); return this; }
        /** Sets the specified value to the {@code y} field. */
        public Buffer y(int value) { XReparentEvent.ny(address(), value); return this; }
        /** Sets the specified value to the {@code override_redirect} field. */
        public Buffer override_redirect(int value) { XReparentEvent.noverride_redirect(address(), value); return this; }
