...
public class IOSQRingOffsets extends Struct<IOSQRingOffsets> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<IOSQRingOffsets, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code head} field. */
        public Buffer head(@NativeType("__u32") int value) { IOSQRingOffsets.nhead(address(), value); return this; }
        /** Sets the specified value to the {@code tail} field. */
        public Buffer tail(@NativeType("__u32") int value) { IOSQRingOffsets.ntail(address(), value); return this; }
        /** Sets the specified value to the {@code ring_mask} field. */
        public Buffer ring_mask(@NativeType("__u32") int value) { IOSQRingOffsets.nring_mask(address(), value); return this; }
        /** Sets the specified value to the {@code ring_entries} field. */
        public Buffer ring_entries(@NativeType("__u32") int value) { IOSQRingOffsets.nring_entries(address(), value); return this; }
        /** Sets the specified value to the {@code flags} field. */
        public Buffer flags(@NativeType("__u32") int value) { IOSQRingOffsets.nflags(address(), value); return this; }
        /** Sets the specified value to the {@code dropped} field. */
        public Buffer dropped(@NativeType("__u32") int value) { IOSQRingOffsets.ndropped(address(), value); return this; }
        /** Sets the specified value to the {@code array} field. */
        public Buffer array(@NativeType("__u32") int value) { IOSQRingOffsets.narray(address(), value); return this; }
