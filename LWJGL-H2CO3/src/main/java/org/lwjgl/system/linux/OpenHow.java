...
public class OpenHow extends Struct<OpenHow> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<OpenHow, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code flags} field. */
        public Buffer flags(@NativeType("__u64") long value) { OpenHow.nflags(address(), value); return this; }
        /** Sets the specified value to the {@code mode} field. */
        public Buffer mode(@NativeType("__u64") long value) { OpenHow.nmode(address(), value); return this; }
        /** Sets the specified value to the {@code resolve} field. */
        public Buffer resolve(@NativeType("__u64") long value) { OpenHow.nresolve(address(), value); return this; }
