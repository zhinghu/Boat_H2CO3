...
public class XSelectionRequestEvent extends Struct<XSelectionRequestEvent> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XSelectionRequestEvent, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(int value) { XSelectionRequestEvent.ntype(address(), value); return this; }
        /** Sets the specified value to the {@link XSelectionRequestEvent#serial} field. */
        public Buffer serial(@NativeType("unsigned long") long value) { XSelectionRequestEvent.nserial(address(), value); return this; }
        /** Sets the specified value to the {@link XSelectionRequestEvent#send_event} field. */
        public Buffer send_event(@NativeType("Bool") boolean value) { XSelectionRequestEvent.nsend_event(address(), value ? 1 : 0); return this; }
        /** Sets the specified value to the {@link XSelectionRequestEvent#display} field. */
        public Buffer display(@NativeType("Display *") long value) { XSelectionRequestEvent.ndisplay(address(), value); return this; }
        /** Sets the specified value to the {@code owner} field. */
        public Buffer owner(@NativeType("Window") long value) { XSelectionRequestEvent.nowner(address(), value); return this; }
        /** Sets the specified value to the {@code requestor} field. */
        public Buffer requestor(@NativeType("Window") long value) { XSelectionRequestEvent.nrequestor(address(), value); return this; }
        /** Sets the specified value to the {@code selection} field. */
        public Buffer selection(@NativeType("Atom") long value) { XSelectionRequestEvent.nselection(address(), value); return this; }
        /** Sets the specified value to the {@code target} field. */
        public Buffer target(@NativeType("Atom") long value) { XSelectionRequestEvent.ntarget(address(), value); return this; }
        /** Sets the specified value to the {@code property} field. */
        public Buffer property(@NativeType("Atom") long value) { XSelectionRequestEvent.nproperty(address(), value); return this; }
        /** Sets the specified value to the {@code time} field. */
        public Buffer time(@NativeType("Time") long value) { XSelectionRequestEvent.ntime(address(), value); return this; }
