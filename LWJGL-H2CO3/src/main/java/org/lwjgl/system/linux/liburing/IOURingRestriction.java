...
public class IOURingRestriction extends Struct<IOURingRestriction> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<IOURingRestriction, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code opcode} field. */
        public Buffer opcode(@NativeType("__u16") short value) { IOURingRestriction.nopcode(address(), value); return this; }
        /** Sets the specified value to the {@code register_op} field. */
        public Buffer register_op(@NativeType("__u8") byte value) { IOURingRestriction.nregister_op(address(), value); return this; }
        /** Sets the specified value to the {@code sqe_op} field. */
        public Buffer sqe_op(@NativeType("__u8") byte value) { IOURingRestriction.nsqe_op(address(), value); return this; }
        /** Sets the specified value to the {@code sqe_flags} field. */
        public Buffer sqe_flags(@NativeType("__u8") byte value) { IOURingRestriction.nsqe_flags(address(), value); return this; }
