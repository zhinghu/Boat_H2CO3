...
public class IOURingBuf extends Struct<IOURingBuf> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<IOURingBuf, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code addr} field. */
        public Buffer addr(@NativeType("__u64") long value) { IOURingBuf.naddr(address(), value); return this; }
        /** Sets the specified value to the {@code len} field. */
        public Buffer len(@NativeType("__u32") int value) { IOURingBuf.nlen(address(), value); return this; }
        /** Sets the specified value to the {@code bid} field. */
        public Buffer bid(@NativeType("__u16") short value) { IOURingBuf.nbid(address(), value); return this; }
        /** Sets the specified value to the {@code resv} field. */
        public Buffer resv(@NativeType("__u16") short value) { IOURingBuf.nresv(address(), value); return this; }
