...
public class IOCQRingOffsets extends Struct<IOCQRingOffsets> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<IOCQRingOffsets, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code head} field. */
        public Buffer head(@NativeType("__u32") int value) { IOCQRingOffsets.nhead(address(), value); return this; }
        /** Sets the specified value to the {@code tail} field. */
        public Buffer tail(@NativeType("__u32") int value) { IOCQRingOffsets.ntail(address(), value); return this; }
        /** Sets the specified value to the {@code ring_mask} field. */
        public Buffer ring_mask(@NativeType("__u32") int value) { IOCQRingOffsets.nring_mask(address(), value); return this; }
        /** Sets the specified value to the {@code ring_entries} field. */
        public Buffer ring_entries(@NativeType("__u32") int value) { IOCQRingOffsets.nring_entries(address(), value); return this; }
        /** Sets the specified value to the {@code overflow} field. */
        public Buffer overflow(@NativeType("__u32") int value) { IOCQRingOffsets.noverflow(address(), value); return this; }
        /** Sets the specified value to the {@code cqes} field. */
        public Buffer cqes(@NativeType("__u32") int value) { IOCQRingOffsets.ncqes(address(), value); return this; }
        /** Sets the specified value to the {@code flags} field. */
        public Buffer flags(@NativeType("__u32") int value) { IOCQRingOffsets.nflags(address(), value); return this; }
