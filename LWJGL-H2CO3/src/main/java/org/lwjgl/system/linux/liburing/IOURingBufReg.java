...
public class IOURingBufReg extends Struct<IOURingBufReg> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<IOURingBufReg, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code ring_addr} field. */
        public Buffer ring_addr(@NativeType("__u64") long value) { IOURingBufReg.nring_addr(address(), value); return this; }
        /** Sets the specified value to the {@code ring_entries} field. */
        public Buffer ring_entries(@NativeType("__u32") int value) { IOURingBufReg.nring_entries(address(), value); return this; }
        /** Sets the specified value to the {@code bgid} field. */
        public Buffer bgid(@NativeType("__u16") short value) { IOURingBufReg.nbgid(address(), value); return this; }
        /** Sets the specified value to the {@code flags} field. */
        public Buffer flags(@NativeType("__u16") short value) { IOURingBufReg.nflags(address(), value); return this; }
        /** Copies the specified {@link LongBuffer} to the {@code resv} field. */
        public Buffer resv(@NativeType("__u64[3]") LongBuffer value) { IOURingBufReg.nresv(address(), value); return this; }
        /** Sets the specified value at the specified index of the {@code resv} field. */
        public Buffer resv(int index, @NativeType("__u64") long value) { IOURingBufReg.nresv(address(), index, value); return this; }
