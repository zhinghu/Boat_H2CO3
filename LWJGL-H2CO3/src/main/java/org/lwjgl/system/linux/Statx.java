...
public class Statx extends Struct<Statx> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<Statx, Buffer> implements NativeResource {
        ...
        public Buffer stx_mask(@NativeType("__u32") int value) { Statx.nstx_mask(address(), value); return this; }
        /** Sets the specified value to the {@link Statx#stx_blksize} field. */
        public Buffer stx_blksize(@NativeType("__u32") int value) { Statx.nstx_blksize(address(), value); return this; }
        /** Sets the specified value to the {@link Statx#stx_attributes} field. */
        public Buffer stx_attributes(@NativeType("__u64") long value) { Statx.nstx_attributes(address(), value); return this; }
        /** Sets the specified value to the {@link Statx#stx_nlink} field. */
        public Buffer stx_nlink(@NativeType("__u32") int value) { Statx.nstx_nlink(address(), value); return this; }
        /** Sets the specified value to the {@link Statx#stx_uid} field. */
        public Buffer stx_uid(@NativeType("__u32") int value) { Statx.nstx_uid(address(), value); return this; }
        /** Sets the specified value to the {@link Statx#stx_gid} field. */
        public Buffer stx_gid(@NativeType("__u32") int value) { Statx.nstx_gid(address(), value); return this; }
        /** Sets the specified value to the {@link Statx#stx_mode} field. */
        public Buffer stx_mode(@NativeType("__u16") short value) { Statx.nstx_mode(address(), value); return this; }
        /** Sets the specified value to the {@link Statx#stx_ino} field. */
        public Buffer stx_ino(@NativeType("__u64") long value) { Statx.nstx_ino(address(), value); return this; }
        /** Sets the specified value to the {@link Statx#stx_size} field. */
        public Buffer stx_size(@NativeType("__u64") long value) { Statx.nstx_size(address(), value); return this; }
        /** Sets the specified value to the {@link Statx#stx_blocks} field. */
        public Buffer stx_blocks(@NativeType("__u64") long value) { Statx.nstx_blocks(address(), value); return this; }
        /** Sets the specified value to the {@link Statx#stx_attributes_mask} field. */
        public Buffer stx_attributes_mask(@NativeType("__u64") long value) { Statx.nstx_attributes_mask(address(), value); return this; }
        /** Copies the specified {@link StatxTimestamp} to the {@link Statx#stx_atime} field. */
        public Buffer stx_atime(@NativeType("struct statx_timestamp") StatxTimestamp value) { Statx.nstx_atime(address(), value); return this; }
        /** Passes the {@link Statx#stx_atime} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer stx_atime(java.util.function.Consumer<StatxTimestamp> consumer) { consumer.accept(stx_atime()); return this; }
        /** Copies the specified {@link StatxTimestamp} to the {@link Statx#stx_btime} field. */
        public Buffer stx_btime(@NativeType("struct statx_timestamp") StatxTimestamp value) { Statx.nstx_btime(address(), value); return this; }
        /** Passes the {@link Statx#stx_btime} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer stx_btime(java.util.function.Consumer<StatxTimestamp> consumer) { consumer.accept(stx_btime()); return this; }
        /** Copies the specified {@link StatxTimestamp} to the {@link Statx#stx_ctime} field. */
        public Buffer stx_ctime(@NativeType("struct statx_timestamp") StatxTimestamp value) { Statx.nstx_ctime(address(), value); return this; }
        /** Passes the {@link Statx#stx_ctime} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer stx_ctime(java.util.function.Consumer<StatxTimestamp> consumer) { consumer.accept(stx_ctime()); return this; }
        /** Copies the specified {@link StatxTimestamp} to the {@link Statx#stx_mtime} field. */
        public Buffer stx_mtime(@NativeType("struct statx_timestamp") StatxTimestamp value) { Statx.nstx_mtime(address(), value); return this; }
        /** Passes the {@link Statx#stx_mtime} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer stx_mtime(java.util.function.Consumer<StatxTimestamp> consumer) { consumer.accept(stx_mtime()); return this; }
        /** Sets the specified value to the {@link Statx#stx_rdev_major} field. */
        public Buffer stx_rdev_major(@NativeType("__u32") int value) { Statx.nstx_rdev_major(address(), value); return this; }
        /** Sets the specified value to the {@code stx_rdev_minor} field. */
        public Buffer stx_rdev_minor(@NativeType("__u32") int value) { Statx.nstx_rdev_minor(address(), value); return this; }
        /** Sets the specified value to the {@link Statx#stx_dev_major} field. */
        public Buffer stx_dev_major(@NativeType("__u32") int value) { Statx.nstx_dev_major(address(), value); return this; }
        /** Sets the specified value to the {@code stx_dev_minor} field. */
        public Buffer stx_dev_minor(@NativeType("__u32") int value) { Statx.nstx_dev_minor(address(), value); return this; }
        /** Sets the specified value to the {@code stx_mnt_id} field. */
        public Buffer stx_mnt_id(@NativeType("__u64") long value) { Statx.nstx_mnt_id(address(), value); return this; }
