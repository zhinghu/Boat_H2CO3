...
public class CMsghdr extends Struct<CMsghdr> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<CMsghdr, Buffer> implements NativeResource {
        ...
        public Buffer cmsg_len(@NativeType("socklen_t") int value) { CMsghdr.ncmsg_len(address(), value); return this; }
        /** Sets the specified value to the {@link CMsghdr#cmsg_level} field. */
        public Buffer cmsg_level(int value) { CMsghdr.ncmsg_level(address(), value); return this; }
        /** Sets the specified value to the {@link CMsghdr#cmsg_type} field. */
        public Buffer cmsg_type(int value) { CMsghdr.ncmsg_type(address(), value); return this; }
        /** Copies the specified {@link ByteBuffer} to the {@code cmsg_data} field. */
        public Buffer cmsg_data(@NativeType("char[0]") ByteBuffer value) { CMsghdr.ncmsg_data(address(), value); return this; }
        /** Sets the specified value at the specified index of the {@code cmsg_data} field. */
        public Buffer cmsg_data(int index, @NativeType("char") byte value) { CMsghdr.ncmsg_data(address(), index, value); return this; }
