...
public class XUnmapEvent extends Struct<XUnmapEvent> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XUnmapEvent, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(int value) { XUnmapEvent.ntype(address(), value); return this; }
        /** Sets the specified value to the {@link XUnmapEvent#serial} field. */
        public Buffer serial(@NativeType("unsigned long") long value) { XUnmapEvent.nserial(address(), value); return this; }
        /** Sets the specified value to the {@link XUnmapEvent#send_event} field. */
        public Buffer send_event(@NativeType("Bool") boolean value) { XUnmapEvent.nsend_event(address(), value ? 1 : 0); return this; }
        /** Sets the specified value to the {@link XUnmapEvent#display} field. */
        public Buffer display(@NativeType("Display *") long value) { XUnmapEvent.ndisplay(address(), value); return this; }
        /** Sets the specified value to the {@code event} field. */
        public Buffer event(@NativeType("Window") long value) { XUnmapEvent.nevent(address(), value); return this; }
        /** Sets the specified value to the {@code window} field. */
        public Buffer window(@NativeType("Window") long value) { XUnmapEvent.nwindow(address(), value); return this; }
        /** Sets the specified value to the {@code from_configure} field. */
        public Buffer from_configure(int value) { XUnmapEvent.nfrom_configure(address(), value); return this; }
