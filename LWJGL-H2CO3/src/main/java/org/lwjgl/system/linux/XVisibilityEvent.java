...
public class XVisibilityEvent extends Struct<XVisibilityEvent> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XVisibilityEvent, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(int value) { XVisibilityEvent.ntype(address(), value); return this; }
        /** Sets the specified value to the {@link XVisibilityEvent#serial} field. */
        public Buffer serial(@NativeType("unsigned long") long value) { XVisibilityEvent.nserial(address(), value); return this; }
        /** Sets the specified value to the {@link XVisibilityEvent#send_event} field. */
        public Buffer send_event(@NativeType("Bool") boolean value) { XVisibilityEvent.nsend_event(address(), value ? 1 : 0); return this; }
        /** Sets the specified value to the {@link XVisibilityEvent#display} field. */
        public Buffer display(@NativeType("Display *") long value) { XVisibilityEvent.ndisplay(address(), value); return this; }
