...
public class IOURingSyncCancelReg extends Struct<IOURingSyncCancelReg> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<IOURingSyncCancelReg, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code addr} field. */
        public Buffer addr(@NativeType("__u64") long value) { IOURingSyncCancelReg.naddr(address(), value); return this; }
        /** Sets the specified value to the {@code fd} field. */
        public Buffer fd(@NativeType("__s32") int value) { IOURingSyncCancelReg.nfd(address(), value); return this; }
        /** Sets the specified value to the {@code flags} field. */
        public Buffer flags(@NativeType("__u32") int value) { IOURingSyncCancelReg.nflags(address(), value); return this; }
        /** Copies the specified {@link KernelTimespec} to the {@code timeout} field. */
        public Buffer timeout(@NativeType("struct __kernel_timespec") KernelTimespec value) { IOURingSyncCancelReg.ntimeout(address(), value); return this; }
        /** Passes the {@code timeout} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer timeout(java.util.function.Consumer<KernelTimespec> consumer) { consumer.accept(timeout()); return this; }
