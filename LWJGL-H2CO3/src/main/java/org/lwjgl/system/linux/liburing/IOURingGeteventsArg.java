...
public class IOURingGeteventsArg extends Struct<IOURingGeteventsArg> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<IOURingGeteventsArg, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code sigmask} field. */
        public Buffer sigmask(@NativeType("__u64") long value) { IOURingGeteventsArg.nsigmask(address(), value); return this; }
        /** Sets the specified value to the {@code sigmask_sz} field. */
        public Buffer sigmask_sz(@NativeType("__u32") int value) { IOURingGeteventsArg.nsigmask_sz(address(), value); return this; }
        /** Sets the specified value to the {@code pad} field. */
        public Buffer pad(@NativeType("__u32") int value) { IOURingGeteventsArg.npad(address(), value); return this; }
        /** Sets the specified value to the {@code ts} field. */
        public Buffer ts(@NativeType("__u64") long value) { IOURingGeteventsArg.nts(address(), value); return this; }
