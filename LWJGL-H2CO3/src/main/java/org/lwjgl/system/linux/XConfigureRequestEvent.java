...
public class XConfigureRequestEvent extends Struct<XConfigureRequestEvent> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XConfigureRequestEvent, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code window} field. */
        public Buffer window(@NativeType("Window") long value) { XConfigureRequestEvent.nwindow(address(), value); return this; }
        /** Sets the specified value to the {@code x} field. */
        public Buffer x(int value) { XConfigureRequestEvent.nx(address(), value); return this; }
        /** Sets the specified value to the {@code y} field. */
        public Buffer y(int value) { XConfigureRequestEvent.ny(address(), value); return this; }
        /** Sets the specified value to the {@code width} field. */
        public Buffer width(int value) { XConfigureRequestEvent.nwidth(address(), value); return this; }
        /** Sets the specified value to the {@code height} field. */
        public Buffer height(int value) { XConfigureRequestEvent.nheight(address(), value); return this; }
        /** Sets the specified value to the {@code border_width} field. */
