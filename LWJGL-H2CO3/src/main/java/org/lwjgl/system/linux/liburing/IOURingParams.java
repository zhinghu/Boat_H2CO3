...
public class IOURingParams extends Struct<IOURingParams> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<IOURingParams, Buffer> implements NativeResource {
        ...
        public Buffer sq_entries(@NativeType("__u32") int value) { IOURingParams.nsq_entries(address(), value); return this; }
        /** Sets the specified value to the {@code cq_entries} field. */
        public Buffer cq_entries(@NativeType("__u32") int value) { IOURingParams.ncq_entries(address(), value); return this; }
        /** Sets the specified value to the {@link IOURingParams#flags} field. */
        public Buffer flags(@NativeType("__u32") int value) { IOURingParams.nflags(address(), value); return this; }
        /** Sets the specified value to the {@code sq_thread_cpu} field. */
        public Buffer sq_thread_cpu(@NativeType("__u32") int value) { IOURingParams.nsq_thread_cpu(address(), value); return this; }
        /** Sets the specified value to the {@code sq_thread_idle} field. */
        public Buffer sq_thread_idle(@NativeType("__u32") int value) { IOURingParams.nsq_thread_idle(address(), value); return this; }
        /** Sets the specified value to the {@link IOURingParams#features} field. */
        public Buffer features(@NativeType("__u32") int value) { IOURingParams.nfeatures(address(), value); return this; }
        /** Sets the specified value to the {@code wq_fd} field. */
        public Buffer wq_fd(@NativeType("__u32") int value) { IOURingParams.nwq_fd(address(), value); return this; }
        /** Copies the specified {@link IntBuffer} to the {@code resv} field. */
        public Buffer resv(@NativeType("__u32[3]") IntBuffer value) { IOURingParams.nresv(address(), value); return this; }
        /** Sets the specified value at the specified index of the {@code resv} field. */
        public Buffer resv(int index, @NativeType("__u32") int value) { IOURingParams.nresv(address(), index, value); return this; }
        /** Copies the specified {@link IOSQRingOffsets} to the {@link IOURingParams#sq_off} field. */
        public Buffer sq_off(@NativeType("struct io_sqring_offsets") IOSQRingOffsets value) { IOURingParams.nsq_off(address(), value); return this; }
        /** Passes the {@link IOURingParams#sq_off} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer sq_off(java.util.function.Consumer<IOSQRingOffsets> consumer) { consumer.accept(sq_off()); return this; }
        /** Copies the specified {@link IOCQRingOffsets} to the {@code cq_off} field. */
        public Buffer cq_off(@NativeType("struct io_cqring_offsets") IOCQRingOffsets value) { IOURingParams.ncq_off(address(), value); return this; }
        /** Passes the {@code cq_off} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer cq_off(java.util.function.Consumer<IOCQRingOffsets> consumer) { consumer.accept(cq_off()); return this; }
