...
public class Visual extends Struct<Visual> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<Visual, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code ext_data} field. */
        public Buffer ext_data(@NativeType("void *") long value) { Visual.next_data(address(), value); return this; }
        /** Sets the specified value to the {@code visualid} field. */
        public Buffer visualid(@NativeType("VisualID") long value) { Visual.nvisualid(address(), value); return this; }
        /** Sets the specified value to the {@code class} field. */
        public Buffer class$(int value) { Visual.nclass$(address(), value); return this; }
        /** Sets the specified value to the {@code red_mask} field. */
        public Buffer red_mask(@NativeType("unsigned long") long value) { Visual.nred_mask(address(), value); return this; }
        /** Sets the specified value to the {@code green_mask} field. */
        public Buffer green_mask(@NativeType("unsigned long") long value) { Visual.ngreen_mask(address(), value); return this; }
        /** Sets the specified value to the {@code blue_mask} field. */
