...
public class IOURingProbe extends Struct<IOURingProbe> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<IOURingProbe, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code last_op} field. */
        public Buffer last_op(@NativeType("__u8") byte value) { IOURingProbe.nlast_op(address(), value); return this; }
        /** Sets the specified value to the {@code ops_len} field. */
        public Buffer ops_len(@NativeType("__u8") byte value) { IOURingProbe.nops_len(address(), value); return this; }
        /** Sets the specified value to the {@code resv} field. */
        public Buffer resv(@NativeType("__u16") short value) { IOURingProbe.nresv(address(), value); return this; }
        /** Copies the specified {@link IOURingProbeOp.Buffer} to the {@code ops} field. */
        public Buffer ops(@NativeType("struct io_uring_probe_op[0]") IOURingProbeOp.Buffer value) { IOURingProbe.nops(address(), value); return this; }
        /** Copies the specified {@link IOURingProbeOp} at the specified index of the {@code ops} field. */
        public Buffer ops(int index, @NativeType("struct io_uring_probe_op") IOURingProbeOp value) { IOURingProbe.nops(address(), index, value); return this; }
        /** Passes the {@code ops} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer ops(java.util.function.Consumer<IOURingProbeOp.Buffer> consumer) { consumer.accept(ops()); return this; }
        /** Passes the element at {@code index} of the {@code ops} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer ops(int index, java.util.function.Consumer<IOURingProbeOp> consumer) { consumer.accept(ops(index)); return this; }
