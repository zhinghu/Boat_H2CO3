...
public class IOURingCQE extends Struct<IOURingCQE> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<IOURingCQE, Buffer> implements NativeResource {
        ...
        public Buffer user_data(@NativeType("__u64") long value) { IOURingCQE.nuser_data(address(), value); return this; }
        /** Sets the specified value to the {@link IOURingCQE#res} field. */
        public Buffer res(@NativeType("__s32") int value) { IOURingCQE.nres(address(), value); return this; }
        /** Sets the specified value to the {@link IOURingCQE#flags} field. */
        public Buffer flags(@NativeType("__u32") int value) { IOURingCQE.nflags(address(), value); return this; }
        /** Copies the specified {@link LongBuffer} to the {@link IOURingCQE#big_cqe} field. */
        public Buffer big_cqe(@NativeType("__u64[0]") LongBuffer value) { IOURingCQE.nbig_cqe(address(), value); return this; }
        /** Sets the specified value at the specified index of the {@link IOURingCQE#big_cqe} field. */
        public Buffer big_cqe(int index, @NativeType("__u64") long value) { IOURingCQE.nbig_cqe(address(), index, value); return this; }
