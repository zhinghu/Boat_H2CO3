...
public class IOURingBufRing extends Struct<IOURingBufRing> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<IOURingBufRing, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code resv1} field. */
        public Buffer resv1(@NativeType("__u64") long value) { IOURingBufRing.nresv1(address(), value); return this; }
        /** Sets the specified value to the {@code resv2} field. */
        public Buffer resv2(@NativeType("__u32") int value) { IOURingBufRing.nresv2(address(), value); return this; }
        /** Sets the specified value to the {@code resv3} field. */
        public Buffer resv3(@NativeType("__u16") short value) { IOURingBufRing.nresv3(address(), value); return this; }
        /** Sets the specified value to the {@code tail} field. */
        public Buffer tail(@NativeType("__u16") short value) { IOURingBufRing.ntail(address(), value); return this; }
        /** Copies the specified {@link IOURingBuf.Buffer} to the {@code bufs} field. */
        public Buffer bufs(@NativeType("struct io_uring_buf[0]") IOURingBuf.Buffer value) { IOURingBufRing.nbufs(address(), value); return this; }
        /** Copies the specified {@link IOURingBuf} at the specified index of the {@code bufs} field. */
        public Buffer bufs(int index, @NativeType("struct io_uring_buf") IOURingBuf value) { IOURingBufRing.nbufs(address(), index, value); return this; }
        /** Passes the {@code bufs} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer bufs(java.util.function.Consumer<IOURingBuf.Buffer> consumer) { consumer.accept(bufs()); return this; }
        /** Passes the element at {@code index} of the {@code bufs} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer bufs(int index, java.util.function.Consumer<IOURingBuf> consumer) { consumer.accept(bufs(index)); return this; }
