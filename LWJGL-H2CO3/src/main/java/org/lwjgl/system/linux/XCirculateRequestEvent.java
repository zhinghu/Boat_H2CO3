...
public class XCirculateRequestEvent extends Struct<XCirculateRequestEvent> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XCirculateRequestEvent, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(int value) { XCirculateRequestEvent.ntype(address(), value); return this; }
        /** Sets the specified value to the {@link XCirculateRequestEvent#serial} field. */
        public Buffer serial(@NativeType("unsigned long") long value) { XCirculateRequestEvent.nserial(address(), value); return this; }
        /** Sets the specified value to the {@link XCirculateRequestEvent#send_event} field. */
        public Buffer send_event(@NativeType("Bool") boolean value) { XCirculateRequestEvent.nsend_event(address(), value ? 1 : 0); return this; }
        /** Sets the specified value to the {@link XCirculateRequestEvent#display} field. */
        public Buffer display(@NativeType("Display *") long value) { XCirculateRequestEvent.ndisplay(address(), value); return this; }
        /** Sets the specified value to the {@code parent} field. */
        public Buffer parent(@NativeType("Window") long value) { XCirculateRequestEvent.nparent(address(), value); return this; }
        /** Sets the specified value to the {@code window} field. */
