...
public class IOURingRSRCUpdate extends Struct<IOURingRSRCUpdate> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<IOURingRSRCUpdate, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code offset} field. */
        public Buffer offset(@NativeType("__u32") int value) { IOURingRSRCUpdate.noffset(address(), value); return this; }
        /** Sets the specified value to the {@code resv} field. */
        public Buffer resv(@NativeType("__u32") int value) { IOURingRSRCUpdate.nresv(address(), value); return this; }
        /** Sets the specified value to the {@code data} field. */
        public Buffer data(@NativeType("__u64") long value) { IOURingRSRCUpdate.ndata(address(), value); return this; }
