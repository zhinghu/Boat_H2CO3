...
public class IOURing extends Struct<IOURing> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<IOURing, Buffer> implements NativeResource {
        ...
        /** Copies the specified {@link IOURingSQ} to the {@code sq} field. */
        public Buffer sq(@NativeType("struct io_uring_sq") IOURingSQ value) { IOURing.nsq(address(), value); return this; }
        /** Passes the {@code sq} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer sq(java.util.function.Consumer<IOURingSQ> consumer) { consumer.accept(sq()); return this; }
        /** Copies the specified {@link IOURingCQ} to the {@code cq} field. */
        public Buffer cq(@NativeType("struct io_uring_cq") IOURingCQ value) { IOURing.ncq(address(), value); return this; }
        /** Passes the {@code cq} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer cq(java.util.function.Consumer<IOURingCQ> consumer) { consumer.accept(cq()); return this; }
        /** Sets the specified value to the {@code flags} field. */
        public Buffer flags(@NativeType("unsigned int") int value) { IOURing.nflags(address(), value); return this; }
        /** Sets the specified value to the {@code ring_fd} field. */
        public Buffer ring_fd(int value) { IOURing.nring_fd(address(), value); return this; }
        /** Sets the specified value to the {@code features} field. */
        public Buffer features(@NativeType("unsigned int") int value) { IOURing.nfeatures(address(), value); return this; }
        /** Sets the specified value to the {@code enter_ring_fd} field. */
        public Buffer enter_ring_fd(int value) { IOURing.nenter_ring_fd(address(), value); return this; }
        /** Sets the specified value to the {@code int_flags} field. */
        public Buffer int_flags(@NativeType("__u8") byte value) { IOURing.nint_flags(address(), value); return this; }
