...
public class Flock extends Struct<Flock> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<Flock, Buffer> implements NativeResource {
        ...
        public Buffer l_type(short value) { Flock.nl_type(address(), value); return this; }
        /** Sets the specified value to the {@link Flock#l_whence} field. */
        public Buffer l_whence(short value) { Flock.nl_whence(address(), value); return this; }
        /** Sets the specified value to the {@link Flock#l_start} field. */
        public Buffer l_start(@NativeType("off_t") long value) { Flock.nl_start(address(), value); return this; }
        /** Sets the specified value to the {@link Flock#l_len} field. */
        public Buffer l_len(@NativeType("off_t") long value) { Flock.nl_len(address(), value); return this; }
        /** Sets the specified value to the {@link Flock#l_pid} field. */
        public Buffer l_pid(@NativeType("pid_t") int value) { Flock.nl_pid(address(), value); return this; }
