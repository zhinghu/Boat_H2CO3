...
public class KEYBDINPUT extends Struct<KEYBDINPUT> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<KEYBDINPUT, Buffer> implements NativeResource {
        ...
        public Buffer wVk(@NativeType("WORD") short value) { KEYBDINPUT.nwVk(address(), value); return this; }
        /** Sets the specified value to the {@link KEYBDINPUT#wScan} field. */
        public Buffer wScan(@NativeType("WORD") short value) { KEYBDINPUT.nwScan(address(), value); return this; }
        /** Sets the specified value to the {@link KEYBDINPUT#dwFlags} field. */
        public Buffer dwFlags(@NativeType("DWORD") int value) { KEYBDINPUT.ndwFlags(address(), value); return this; }
        /** Sets the specified value to the {@link KEYBDINPUT#time} field. */
        public Buffer time(@NativeType("DWORD") int value) { KEYBDINPUT.ntime(address(), value); return this; }
        /** Sets the specified value to the {@link KEYBDINPUT#dwExtraInfo} field. */
        public Buffer dwExtraInfo(@NativeType("ULONG_PTR") long value) { KEYBDINPUT.ndwExtraInfo(address(), value); return this; }
