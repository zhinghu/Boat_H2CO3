...
public class MOUSEINPUT extends Struct<MOUSEINPUT> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<MOUSEINPUT, Buffer> implements NativeResource {
        ...
        public Buffer dx(@NativeType("LONG") int value) { MOUSEINPUT.ndx(address(), value); return this; }
        /** Sets the specified value to the {@link MOUSEINPUT#dy} field. */
        public Buffer dy(@NativeType("LONG") int value) { MOUSEINPUT.ndy(address(), value); return this; }
        /** Sets the specified value to the {@link MOUSEINPUT#mouseData} field. */
        public Buffer mouseData(@NativeType("DWORD") int value) { MOUSEINPUT.nmouseData(address(), value); return this; }
        /** Sets the specified value to the {@link MOUSEINPUT#dwFlags} field. */
        public Buffer dwFlags(@NativeType("DWORD") int value) { MOUSEINPUT.ndwFlags(address(), value); return this; }
