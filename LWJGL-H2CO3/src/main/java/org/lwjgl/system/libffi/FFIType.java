...
public class FFIType extends Struct<FFIType> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<FFIType, Buffer> implements NativeResource {
        ...
        public Buffer size(@NativeType("size_t") long value) { FFIType.nsize(address(), value); return this; }
        /** Sets the specified value to the {@link FFIType#alignment} field. */
        public Buffer alignment(@NativeType("unsigned short") short value) { FFIType.nalignment(address(), value); return this; }
        /** Sets the specified value to the {@link FFIType#type} field. */
        public Buffer type(@NativeType("unsigned short") short value) { FFIType.ntype(address(), value); return this; }
        /** Sets the address of the specified {@link PointerBuffer} to the {@link FFIType#elements} field. */
        public Buffer elements(@Nullable @NativeType("ffi_type *") PointerBuffer value) { FFIType.nelements(address(), value); return this; }
