...
public class Display {
    ...
    public static void create() throws LWJGLException {
        ...
        Window.charCallback = new GLFWCharCallback() {
            ...
            public void invoke(long window, int codepoint) {
                GLFWInputImplementation.singleton.putKeyboardEvent(0, (byte) 1, codepoint, Sys.getNanoTime(), false);
            }
        };
        ...
        if (parent != null)
            parent.setSize(displayWidth, displayHeight);
        Mouse.create();
        Keyboard.create();
    ...
    public static void setFullscreen(boolean fullscreen) throws LWJGLException {
        System.out.println("LWJGL: switch fullscreen to " + fullscreen);
