...
public class FTC_Scaler extends Struct<FTC_Scaler> {
    ...
    public static long nface_id(long struct) {
        return memGetAddress(struct + FTC_Scaler.FACE_ID);
    }
    ...
    public static int nwidth(long struct) {
        return UNSAFE.getInt(null, struct + FTC_Scaler.WIDTH);
    }
    ...
    public static int nheight(long struct) {
        return UNSAFE.getInt(null, struct + FTC_Scaler.HEIGHT);
    }
    ...
    public static int npixel(long struct) {
        return UNSAFE.getInt(null, struct + FTC_Scaler.PIXEL);
    }
    ...
    public static int nx_res(long struct) {
        return UNSAFE.getInt(null, struct + FTC_Scaler.X_RES);
    }
    ...
    public static int ny_res(long struct) {
        return UNSAFE.getInt(null, struct + FTC_Scaler.Y_RES);
    }
