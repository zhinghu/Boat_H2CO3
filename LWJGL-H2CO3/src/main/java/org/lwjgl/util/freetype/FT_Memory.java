...
public class FT_Memory extends Struct<FT_Memory> implements NativeResource {
    ...
    public static long nuser(long struct) {
        return memGetAddress(struct + FT_Memory.USER);
    }
    ...
    public static FT_Free_Func nfree$(long struct) {
        return FT_Free_Func.createSafe(memGetAddress(struct + FT_Memory.FREE));
    }
    ...
    public static FT_Realloc_Func nrealloc(long struct) {
        return FT_Realloc_Func.createSafe(memGetAddress(struct + FT_Memory.REALLOC));
    }
    ...
    public static void nuser(long struct, long value) {
        memPutAddress(struct + FT_Memory.USER, value);
    }
    ...
    public static void nalloc(long struct, @Nullable FT_Alloc_FuncI value) {
        memPutAddress(struct + FT_Memory.ALLOC, memAddressSafe(value));
    }
    ...
    public static void nfree$(long struct, @Nullable FT_Free_FuncI value) {
        memPutAddress(struct + FT_Memory.FREE, memAddressSafe(value));
    }
    ...
    public static void nrealloc(long struct, @Nullable FT_Realloc_FuncI value) {
        memPutAddress(struct + FT_Memory.REALLOC, memAddressSafe(value));
    }
     ...
     */
    public FT_Memory user(@NativeType("void *") long value) {
        nuser(address(), value);
        return this;
    }
     ...
     */
    public FT_Memory alloc(@Nullable @NativeType("FT_Alloc_Func") FT_Alloc_FuncI value) {
        nalloc(address(), value);
        return this;
    }
     ...
     */
    public FT_Memory free$(@Nullable @NativeType("FT_Free_Func") FT_Free_FuncI value) {
        nfree$(address(), value);
        return this;
    }
     ...
     */
    public FT_Memory realloc(@Nullable @NativeType("FT_Realloc_Func") FT_Realloc_FuncI value) {
        nrealloc(address(), value);
        return this;
    }
    ...
    public static class Buffer extends StructBuffer<FT_Memory, Buffer> implements NativeResource {
         ...
         * Sets the specified value to the {@code alloc} field.
         */
        public Buffer alloc(@Nullable @NativeType("FT_Alloc_Func") FT_Alloc_FuncI value) {
            FT_Memory.nalloc(address(), value);
            return this;
        }
         ...
         * Sets the specified value to the {@code free} field.
         */
        public Buffer free$(@Nullable @NativeType("FT_Free_Func") FT_Free_FuncI value) {
            FT_Memory.nfree$(address(), value);
            return this;
        }
         ...
         * Sets the specified value to the {@code realloc} field.
         */
        public Buffer realloc(@Nullable @NativeType("FT_Realloc_Func") FT_Realloc_FuncI value) {
            FT_Memory.nrealloc(address(), value);
            return this;
        }
