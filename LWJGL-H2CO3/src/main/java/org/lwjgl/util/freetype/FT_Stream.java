...
public class FT_Stream extends Struct<FT_Stream> implements NativeResource {
    ...
    public static ByteBuffer nbase(long struct) {
        return memByteBufferSafe(memGetAddress(struct + FT_Stream.BASE), (int) nsize(struct));
    }
    ...
    public static long nsize(long struct) {
        return memGetCLong(struct + FT_Stream.SIZE);
    }
    ...
    public static long npos(long struct) {
        return memGetCLong(struct + FT_Stream.POS);
    }
    ...
    public static FT_StreamDesc ndescriptor(long struct) {
        return FT_StreamDesc.create(struct + FT_Stream.DESCRIPTOR);
    }
    ...
    public static FT_StreamDesc npathname(long struct) {
        return FT_StreamDesc.create(struct + FT_Stream.PATHNAME);
    }
    ...
    public static FT_Stream_IoFunc nread(long struct) {
        return FT_Stream_IoFunc.createSafe(memGetAddress(struct + FT_Stream.READ));
    }
    ...
    public static FT_Stream_CloseFunc nclose$(long struct) {
        return FT_Stream_CloseFunc.createSafe(memGetAddress(struct + FT_Stream.CLOSE));
    }

    @Nullable
    public static FT_Memory nmemory(long struct) {
        return FT_Memory.createSafe(memGetAddress(struct + FT_Stream.MEMORY));
    }

    @Nullable
    public static ByteBuffer ncursor(long struct, int capacity) {
        return memByteBufferSafe(memGetAddress(struct + FT_Stream.CURSOR), capacity);
    }

    @Nullable
    public static ByteBuffer nlimit$(long struct, int capacity) {
        return memByteBufferSafe(memGetAddress(struct + FT_Stream.LIMIT), capacity);
    }
    ...
    public static void nbase(long struct, @Nullable ByteBuffer value) {
        memPutAddress(struct + FT_Stream.BASE, memAddressSafe(value));
        nsize(struct, value == null ? 0 : value.remaining());
    }
    ...
    public static void nsize(long struct, long value) {
        memPutCLong(struct + FT_Stream.SIZE, value);
    }
    ...
    public static void npos(long struct, long value) {
        memPutCLong(struct + FT_Stream.POS, value);
    }
    ...
    public static void ndescriptor(long struct, FT_StreamDesc value) {
        memCopy(value.address(), struct + FT_Stream.DESCRIPTOR, FT_StreamDesc.SIZEOF);
    }
    ...
    public static void npathname(long struct, FT_StreamDesc value) {
        memCopy(value.address(), struct + FT_Stream.PATHNAME, FT_StreamDesc.SIZEOF);
    }
    ...
    public static void nread(long struct, @Nullable FT_Stream_IoFuncI value) {
        memPutAddress(struct + FT_Stream.READ, memAddressSafe(value));
    }
    ...
    public static void nclose$(long struct, @Nullable FT_Stream_CloseFuncI value) {
        memPutAddress(struct + FT_Stream.CLOSE, memAddressSafe(value));
    }

    public static void nmemory(long struct, @Nullable FT_Memory value) {
        memPutAddress(struct + FT_Stream.MEMORY, memAddressSafe(value));
    }

    public static void ncursor(long struct, @Nullable ByteBuffer value) {
        memPutAddress(struct + FT_Stream.CURSOR, memAddressSafe(value));
    }

    public static void nlimit$(long struct, @Nullable ByteBuffer value) {
        memPutAddress(struct + FT_Stream.LIMIT, memAddressSafe(value));
    }
     ...
     */
    public FT_Stream base(@Nullable @NativeType("unsigned char *") ByteBuffer value) {
        nbase(address(), value);
        return this;
    }
     ...
     */
    public FT_Stream size(@NativeType("unsigned long") long value) {
        nsize(address(), value);
        return this;
    }
     ...
     */
    public FT_Stream pos(@NativeType("unsigned long") long value) {
        npos(address(), value);
        return this;
    }
     ...
     */
    public FT_Stream descriptor(java.util.function.Consumer<FT_StreamDesc> consumer) {
     ...
     */
    public FT_Stream pathname(java.util.function.Consumer<FT_StreamDesc> consumer) {
     ...
     */
    public FT_Stream read(@Nullable @NativeType("FT_Stream_IoFunc") FT_Stream_IoFuncI value) {
        nread(address(), value);
        return this;
    }
     ...
     */
    public FT_Stream close$(@Nullable @NativeType("FT_Stream_CloseFunc") FT_Stream_CloseFuncI value) {
        nclose$(address(), value);
        return this;
    }
    ...
    public static class Buffer extends StructBuffer<FT_Stream, Buffer> implements NativeResource {
         ...
         * Sets the address of the specified {@link ByteBuffer} to the {@code base} field.
         */
        public Buffer base(@Nullable @NativeType("unsigned char *") ByteBuffer value) {
            FT_Stream.nbase(address(), value);
            return this;
        }
         ...
         * Sets the specified value to the {@code size} field.
         */
        public Buffer size(@NativeType("unsigned long") long value) {
            FT_Stream.nsize(address(), value);
            return this;
        }
         ...
         * Sets the specified value to the {@code pos} field.
         */
        public Buffer pos(@NativeType("unsigned long") long value) {
            FT_Stream.npos(address(), value);
            return this;
        }
        ...
        public Buffer descriptor(FT_StreamDesc value) {
            FT_Stream.ndescriptor(address(), value);
            return this;
        }
         ...
         * Passes the {@code descriptor} field to the specified {@link java.util.function.Consumer Consumer}.
         */
        public Buffer descriptor(java.util.function.Consumer<FT_StreamDesc> consumer) {
            consumer.accept(descriptor());
            return this;
        }
        ...
        public Buffer pathname(FT_StreamDesc value) {
            FT_Stream.npathname(address(), value);
            return this;
        }
         ...
         * Passes the {@code pathname} field to the specified {@link java.util.function.Consumer Consumer}.
         */
        public Buffer pathname(java.util.function.Consumer<FT_StreamDesc> consumer) {
            consumer.accept(pathname());
            return this;
        }
         ...
         * Sets the specified value to the {@code read} field.
         */
        public Buffer read(@Nullable @NativeType("FT_Stream_IoFunc") FT_Stream_IoFuncI value) {
            FT_Stream.nread(address(), value);
            return this;
        }
         ...
         * Sets the specified value to the {@code close} field.
         */
        public Buffer close$(@Nullable @NativeType("FT_Stream_CloseFunc") FT_Stream_CloseFuncI value) {
            FT_Stream.nclose$(address(), value);
            return this;
        }
