...
public class FT_Parameter extends Struct<FT_Parameter> implements NativeResource {
    ...
    public static long ntag(long struct) {
        return memGetCLong(struct + FT_Parameter.TAG);
    }
    ...
    public static ByteBuffer ndata(long struct, int capacity) {
        return memByteBufferSafe(memGetAddress(struct + FT_Parameter.DATA), capacity);
    }
    ...
    public static void ntag(long struct, long value) {
        memPutCLong(struct + FT_Parameter.TAG, value);
    }
    ...
    public static void ndata(long struct, @Nullable ByteBuffer value) {
        memPutAddress(struct + FT_Parameter.DATA, memAddressSafe(value));
    }
     ...
     */
    public FT_Parameter tag(@NativeType("FT_ULong") long value) {
        ntag(address(), value);
        return this;
    }
     ...
     */
    public FT_Parameter data(@Nullable @NativeType("FT_Pointer") ByteBuffer value) {
        ndata(address(), value);
        return this;
    }
    ...
    public static class Buffer extends StructBuffer<FT_Parameter, Buffer> implements NativeResource {
        ...
        @NativeType("FT_Pointer")
        public ByteBuffer data(int capacity) {
            return FT_Parameter.ndata(address(), capacity);
        }

        /**
         * Sets the specified value to the {@code tag} field.
         */
        public Buffer tag(@NativeType("FT_ULong") long value) {
            FT_Parameter.ntag(address(), value);
            return this;
        }
         ...
         * Sets the address of the specified {@link ByteBuffer} to the {@code data} field.
         */
        public Buffer data(@Nullable @NativeType("FT_Pointer") ByteBuffer value) {
            FT_Parameter.ndata(address(), value);
            return this;
        }
