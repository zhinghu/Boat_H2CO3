...
public class FT_Open_Args extends Struct<FT_Open_Args> implements NativeResource {
    ...
    public static int nflags(long struct) {
        return UNSAFE.getInt(null, struct + FT_Open_Args.FLAGS);
    }
    ...
    public static ByteBuffer nmemory_base(long struct) {
        return memByteBufferSafe(memGetAddress(struct + FT_Open_Args.MEMORY_BASE), (int) nmemory_size(struct));
    }
    ...
    public static long nmemory_size(long struct) {
        return memGetCLong(struct + FT_Open_Args.MEMORY_SIZE);
    }
    ...
    public static ByteBuffer npathname(long struct) {
        return memByteBufferNT1Safe(memGetAddress(struct + FT_Open_Args.PATHNAME));
    }
    ...
    public static String npathnameString(long struct) {
        return memUTF8Safe(memGetAddress(struct + FT_Open_Args.PATHNAME));
    }
    ...
    public static FT_Stream nstream$(long struct) {
        return FT_Stream.createSafe(memGetAddress(struct + FT_Open_Args.STREAM));
    }
    ...
    public static long ndriver(long struct) {
        return memGetAddress(struct + FT_Open_Args.DRIVER);
    }
    ...
    public static int nnum_params(long struct) {
        return UNSAFE.getInt(null, struct + FT_Open_Args.NUM_PARAMS);
    }
    ...
    public static FT_Parameter.Buffer nparams(long struct) {
        return FT_Parameter.createSafe(memGetAddress(struct + FT_Open_Args.PARAMS), nnum_params(struct));
    }
    ...
    public static void nflags(long struct, int value) {
        UNSAFE.putInt(null, struct + FT_Open_Args.FLAGS, value);
    }
    ...
    public static void nmemory_base(long struct, @Nullable ByteBuffer value) {
        memPutAddress(struct + FT_Open_Args.MEMORY_BASE, memAddressSafe(value));
        nmemory_size(struct, value == null ? 0 : value.remaining());
    }
    ...
    public static void nmemory_size(long struct, long value) {
        memPutCLong(struct + FT_Open_Args.MEMORY_SIZE, value);
    }
    ...
    public static void nstream$(long struct, @Nullable FT_Stream value) {
        memPutAddress(struct + FT_Open_Args.STREAM, memAddressSafe(value));
    }
    ...
    public static void ndriver(long struct, long value) {
        memPutAddress(struct + FT_Open_Args.DRIVER, value);
    }
    ...
    public static void nnum_params(long struct, int value) {
        UNSAFE.putInt(null, struct + FT_Open_Args.NUM_PARAMS, value);
    }
    ...
    public static void nparams(long struct, @Nullable FT_Parameter.Buffer value) {
        memPutAddress(struct + FT_Open_Args.PARAMS, memAddressSafe(value));
        nnum_params(struct, value == null ? 0 : value.remaining());
    }
     ...
     */
    public FT_Open_Args flags(@NativeType("FT_UInt") int value) {
     ...
     */
    public FT_Open_Args memory_base(@Nullable @NativeType("FT_Byte const *") ByteBuffer value) {
        nmemory_base(address(), value);
        return this;
    }
     ...
     */
    public FT_Open_Args memory_size(@NativeType("FT_Long") long value) {
        nmemory_size(address(), value);
        return this;
    }
     ...
     */
    public FT_Open_Args pathname(@Nullable @NativeType("FT_String *") ByteBuffer value) {
     ...
     */
    public FT_Open_Args driver(@NativeType("FT_Module") long value) {
        ndriver(address(), value);
        return this;
    }
     ...
     */
    public FT_Open_Args num_params(@NativeType("FT_Int") int value) {
        nnum_params(address(), value);
        return this;
    }
     ...
     */
    public FT_Open_Args params(@Nullable @NativeType("FT_Parameter *") FT_Parameter.Buffer value) {
        nparams(address(), value);
        return this;
    }
    ...
    public static class Buffer extends StructBuffer<FT_Open_Args, Buffer> implements NativeResource {
         ...
         * Sets the specified value to the {@code flags} field.
         */
        public Buffer flags(@NativeType("FT_UInt") int value) {
            FT_Open_Args.nflags(address(), value);
            return this;
        }
         ...
         * Sets the address of the specified {@link ByteBuffer} to the {@code memory_base} field.
         */
        public Buffer memory_base(@Nullable @NativeType("FT_Byte const *") ByteBuffer value) {
            FT_Open_Args.nmemory_base(address(), value);
            return this;
        }
         ...
         * Sets the specified value to the {@code memory_size} field.
         */
        public Buffer memory_size(@NativeType("FT_Long") long value) {
            FT_Open_Args.nmemory_size(address(), value);
            return this;
        }
         ...
         * Sets the address of the specified encoded string to the {@code pathname} field.
         */
        public Buffer pathname(@Nullable @NativeType("FT_String *") ByteBuffer value) {
            FT_Open_Args.npathname(address(), value);
            return this;
        }
        ...
        public Buffer stream$(@Nullable FT_Stream value) {
            FT_Open_Args.nstream$(address(), value);
            return this;
        }
         ...
         * Sets the specified value to the {@code driver} field.
         */
        public Buffer driver(@NativeType("FT_Module") long value) {
            FT_Open_Args.ndriver(address(), value);
            return this;
        }
         ...
         * Sets the specified value to the {@code num_params} field.
         */
        public Buffer num_params(@NativeType("FT_Int") int value) {
            FT_Open_Args.nnum_params(address(), value);
            return this;
        }
         ...
         * Sets the address of the specified {@link FT_Parameter.Buffer} to the {@code params} field.
         */
        public Buffer params(@Nullable @NativeType("FT_Parameter *") FT_Parameter.Buffer value) {
            FT_Open_Args.nparams(address(), value);
            return this;
        }
