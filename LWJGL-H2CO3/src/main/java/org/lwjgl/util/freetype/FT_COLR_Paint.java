...
public class FT_COLR_Paint extends Struct<FT_COLR_Paint> implements NativeResource {
    ...
    public static int nformat(long struct) {
        return UNSAFE.getInt(null, struct + FT_COLR_Paint.FORMAT);
    }
    ...
    public static FT_PaintColrLayers nu_colr_layers(long struct) {
        return FT_PaintColrLayers.create(struct + FT_COLR_Paint.U_COLR_LAYERS);
    }
    ...
    public static FT_PaintGlyph nu_glyph(long struct) {
        return FT_PaintGlyph.create(struct + FT_COLR_Paint.U_GLYPH);
    }
    ...
    public static FT_PaintSolid nu_solid(long struct) {
        return FT_PaintSolid.create(struct + FT_COLR_Paint.U_SOLID);
    }
    ...
    public static FT_PaintLinearGradient nu_linear_gradient(long struct) {
        return FT_PaintLinearGradient.create(struct + FT_COLR_Paint.U_LINEAR_GRADIENT);
    }
    ...
    public static FT_PaintRadialGradient nu_radial_gradient(long struct) {
        return FT_PaintRadialGradient.create(struct + FT_COLR_Paint.U_RADIAL_GRADIENT);
    }
    ...
    public static FT_PaintSweepGradient nu_sweep_gradient(long struct) {
        return FT_PaintSweepGradient.create(struct + FT_COLR_Paint.U_SWEEP_GRADIENT);
    }
    ...
    public static FT_PaintTransform nu_transform(long struct) {
        return FT_PaintTransform.create(struct + FT_COLR_Paint.U_TRANSFORM);
    }
    ...
    public static FT_PaintTranslate nu_translate(long struct) {
        return FT_PaintTranslate.create(struct + FT_COLR_Paint.U_TRANSLATE);
    }
    ...
    public static FT_PaintScale nu_scale(long struct) {
        return FT_PaintScale.create(struct + FT_COLR_Paint.U_SCALE);
    }
    ...
    public static FT_PaintRotate nu_rotate(long struct) {
        return FT_PaintRotate.create(struct + FT_COLR_Paint.U_ROTATE);
    }
    ...
    public static FT_PaintSkew nu_skew(long struct) {
        return FT_PaintSkew.create(struct + FT_COLR_Paint.U_SKEW);
    }
    ...
    public static FT_PaintComposite nu_composite(long struct) {
        return FT_PaintComposite.create(struct + FT_COLR_Paint.U_COMPOSITE);
    }
    ...
    public static FT_PaintColrGlyph nu_colr_glyph(long struct) {
        return FT_PaintColrGlyph.create(struct + FT_COLR_Paint.U_COLR_GLYPH);
    }
