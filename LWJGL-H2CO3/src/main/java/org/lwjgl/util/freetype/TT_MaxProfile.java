...
public class TT_MaxProfile extends Struct<TT_MaxProfile> {
    ...
    public static long nversion(long struct) {
        return memGetCLong(struct + TT_MaxProfile.VERSION);
    }
    ...
    public static short nnumGlyphs(long struct) {
        return UNSAFE.getShort(null, struct + TT_MaxProfile.NUMGLYPHS);
    }
    ...
    public static short nmaxPoints(long struct) {
        return UNSAFE.getShort(null, struct + TT_MaxProfile.MAXPOINTS);
    }
    ...
    public static short nmaxContours(long struct) {
        return UNSAFE.getShort(null, struct + TT_MaxProfile.MAXCONTOURS);
    }
    ...
    public static short nmaxCompositePoints(long struct) {
        return UNSAFE.getShort(null, struct + TT_MaxProfile.MAXCOMPOSITEPOINTS);
    }
    ...
    public static short nmaxCompositeContours(long struct) {
        return UNSAFE.getShort(null, struct + TT_MaxProfile.MAXCOMPOSITECONTOURS);
    }
    ...
    public static short nmaxZones(long struct) {
        return UNSAFE.getShort(null, struct + TT_MaxProfile.MAXZONES);
    }
    ...
    public static short nmaxTwilightPoints(long struct) {
        return UNSAFE.getShort(null, struct + TT_MaxProfile.MAXTWILIGHTPOINTS);
    }
    ...
    public static short nmaxStorage(long struct) {
        return UNSAFE.getShort(null, struct + TT_MaxProfile.MAXSTORAGE);
    }
    ...
    public static short nmaxFunctionDefs(long struct) {
        return UNSAFE.getShort(null, struct + TT_MaxProfile.MAXFUNCTIONDEFS);
    }
    ...
    public static short nmaxInstructionDefs(long struct) {
        return UNSAFE.getShort(null, struct + TT_MaxProfile.MAXINSTRUCTIONDEFS);
    }
    ...
    public static short nmaxStackElements(long struct) {
        return UNSAFE.getShort(null, struct + TT_MaxProfile.MAXSTACKELEMENTS);
    }
    ...
    public static short nmaxSizeOfInstructions(long struct) {
        return UNSAFE.getShort(null, struct + TT_MaxProfile.MAXSIZEOFINSTRUCTIONS);
    }
    ...
    public static short nmaxComponentElements(long struct) {
        return UNSAFE.getShort(null, struct + TT_MaxProfile.MAXCOMPONENTELEMENTS);
    }
    ...
    public static short nmaxComponentDepth(long struct) {
        return UNSAFE.getShort(null, struct + TT_MaxProfile.MAXCOMPONENTDEPTH);
    }
