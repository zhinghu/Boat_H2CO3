...
public class FT_Bitmap_Size extends Struct<FT_Bitmap_Size> {
    ...
    public static short nheight(long struct) {
        return UNSAFE.getShort(null, struct + FT_Bitmap_Size.HEIGHT);
    }
    ...
    public static short nwidth(long struct) {
        return UNSAFE.getShort(null, struct + FT_Bitmap_Size.WIDTH);
    }
    ...
    public static long nsize(long struct) {
        return memGetCLong(struct + FT_Bitmap_Size.SIZE);
    }
    ...
    public static long nx_ppem(long struct) {
        return memGetCLong(struct + FT_Bitmap_Size.X_PPEM);
    }
    ...
    public static long ny_ppem(long struct) {
        return memGetCLong(struct + FT_Bitmap_Size.Y_PPEM);
    }
