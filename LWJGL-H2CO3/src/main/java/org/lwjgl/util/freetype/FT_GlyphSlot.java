...
public class FT_GlyphSlot extends Struct<FT_GlyphSlot> {
    ...
    public static long nlibrary(long struct) {
        return memGetAddress(struct + FT_GlyphSlot.LIBRARY);
    }
    ...
    public static FT_Face nface(long struct) {
        return FT_Face.create(memGetAddress(struct + FT_GlyphSlot.FACE));
    }
    ...
    public static FT_GlyphSlot nnext(long struct) {
        return FT_GlyphSlot.createSafe(memGetAddress(struct + FT_GlyphSlot.NEXT));
    }
    ...
    public static int nglyph_index(long struct) {
        return UNSAFE.getInt(null, struct + FT_GlyphSlot.GLYPH_INDEX);
    }
    ...
    public static FT_Generic ngeneric(long struct) {
        return FT_Generic.create(struct + FT_GlyphSlot.GENERIC);
    }
    ...
    public static FT_Glyph_Metrics nmetrics(long struct) {
        return FT_Glyph_Metrics.create(struct + FT_GlyphSlot.METRICS);
    }
    ...
    public static long nlinearHoriAdvance(long struct) {
        return memGetCLong(struct + FT_GlyphSlot.LINEARHORIADVANCE);
    }
    ...
    public static long nlinearVertAdvance(long struct) {
        return memGetCLong(struct + FT_GlyphSlot.LINEARVERTADVANCE);
    }
    ...
    public static FT_Vector nadvance(long struct) {
        return FT_Vector.create(struct + FT_GlyphSlot.ADVANCE);
    }
    ...
    public static int nformat(long struct) {
        return UNSAFE.getInt(null, struct + FT_GlyphSlot.FORMAT);
    }
    ...
    public static FT_Bitmap nbitmap(long struct) {
        return FT_Bitmap.create(struct + FT_GlyphSlot.BITMAP);
    }
    ...
    public static int nbitmap_left(long struct) {
        return UNSAFE.getInt(null, struct + FT_GlyphSlot.BITMAP_LEFT);
    }
    ...
    public static int nbitmap_top(long struct) {
        return UNSAFE.getInt(null, struct + FT_GlyphSlot.BITMAP_TOP);
    }
    ...
    public static FT_Outline noutline(long struct) {
        return FT_Outline.create(struct + FT_GlyphSlot.OUTLINE);
    }

    // -----------------------------------

    public static int nnum_subglyphs(long struct) {
        return UNSAFE.getInt(null, struct + FT_GlyphSlot.NUM_SUBGLYPHS);
    }

    public static long nsubglyphs(long struct) {
        return memGetAddress(struct + FT_GlyphSlot.SUBGLYPHS);
    }

    @Nullable
    public static ByteBuffer ncontrol_data(long struct) {
        return memByteBufferSafe(memGetAddress(struct + FT_GlyphSlot.CONTROL_DATA), (int) ncontrol_len(struct));
    }

    public static long ncontrol_len(long struct) {
        return memGetCLong(struct + FT_GlyphSlot.CONTROL_LEN);
    }
    ...
    public static long nlsb_delta(long struct) {
        return memGetCLong(struct + FT_GlyphSlot.LSB_DELTA);
    }
    ...
    public static long nrsb_delta(long struct) {
        return memGetCLong(struct + FT_GlyphSlot.RSB_DELTA);
    }

    public static long nother(long struct) {
        return memGetAddress(struct + FT_GlyphSlot.OTHER);
    }

    public static long ninternal(long struct) {
        return memGetAddress(struct + FT_GlyphSlot.INTERNAL);
    }
