...
public class FT_Face extends Struct<FT_Face> {
    ...
    public static long nnum_faces(long struct) {
        return memGetCLong(struct + FT_Face.NUM_FACES);
    }
    ...
    public static long nface_index(long struct) {
        return memGetCLong(struct + FT_Face.FACE_INDEX);
    }
    ...
    public static long nface_flags(long struct) {
        return memGetCLong(struct + FT_Face.FACE_FLAGS);
    }
    ...
    public static long nstyle_flags(long struct) {
        return memGetCLong(struct + FT_Face.STYLE_FLAGS);
    }
    ...
    public static long nnum_glyphs(long struct) {
        return memGetCLong(struct + FT_Face.NUM_GLYPHS);
    }
    ...
    public static ByteBuffer nfamily_name(long struct) {
        return memByteBufferNT1(memGetAddress(struct + FT_Face.FAMILY_NAME));
    }
    ...
    public static String nfamily_nameString(long struct) {
        return memUTF8(memGetAddress(struct + FT_Face.FAMILY_NAME));
    }
    ...
    public static ByteBuffer nstyle_name(long struct) {
        return memByteBufferNT1(memGetAddress(struct + FT_Face.STYLE_NAME));
    }
    ...
    public static String nstyle_nameString(long struct) {
        return memUTF8(memGetAddress(struct + FT_Face.STYLE_NAME));
    }
    ...
    public static int nnum_fixed_sizes(long struct) {
        return UNSAFE.getInt(null, struct + FT_Face.NUM_FIXED_SIZES);
    }
    ...
    public static FT_Bitmap_Size.Buffer navailable_sizes(long struct) {
        return FT_Bitmap_Size.createSafe(memGetAddress(struct + FT_Face.AVAILABLE_SIZES), nnum_fixed_sizes(struct));
    }
    ...
    public static int nnum_charmaps(long struct) {
        return UNSAFE.getInt(null, struct + FT_Face.NUM_CHARMAPS);
    }
    ...
    public static PointerBuffer ncharmaps(long struct) {
        return memPointerBuffer(memGetAddress(struct + FT_Face.CHARMAPS), nnum_charmaps(struct));
    }
    ...
    public static FT_Generic ngeneric(long struct) {
        return FT_Generic.create(struct + FT_Face.GENERIC);
    }
    ...
    public static FT_BBox nbbox(long struct) {
        return FT_BBox.create(struct + FT_Face.BBOX);
    }
    ...
    public static short nunits_per_EM(long struct) {
        return UNSAFE.getShort(null, struct + FT_Face.UNITS_PER_EM);
    }
    ...
    public static short nascender(long struct) {
        return UNSAFE.getShort(null, struct + FT_Face.ASCENDER);
    }
    ...
    public static short ndescender(long struct) {
        return UNSAFE.getShort(null, struct + FT_Face.DESCENDER);
    }
    ...
    public static short nheight(long struct) {
        return UNSAFE.getShort(null, struct + FT_Face.HEIGHT);
    }
    ...
    public static short nmax_advance_width(long struct) {
        return UNSAFE.getShort(null, struct + FT_Face.MAX_ADVANCE_WIDTH);
    }
    ...
    public static short nmax_advance_height(long struct) {
        return UNSAFE.getShort(null, struct + FT_Face.MAX_ADVANCE_HEIGHT);
    }
    ...
    public static short nunderline_position(long struct) {
        return UNSAFE.getShort(null, struct + FT_Face.UNDERLINE_POSITION);
    }
    ...
    public static short nunderline_thickness(long struct) {
        return UNSAFE.getShort(null, struct + FT_Face.UNDERLINE_THICKNESS);
    }
    ...
    public static FT_GlyphSlot nglyph(long struct) {
        return FT_GlyphSlot.createSafe(memGetAddress(struct + FT_Face.GLYPH));
    }
    ...
    public static FT_Size nsize(long struct) {
        return FT_Size.createSafe(memGetAddress(struct + FT_Face.SIZE));
    }
    ...
    public static FT_CharMap ncharmap(long struct) {
        return FT_CharMap.createSafe(memGetAddress(struct + FT_Face.CHARMAP));
    }

    public static long ndriver(long struct) {
        return memGetAddress(struct + FT_Face.DRIVER);
    }

    @Nullable
    public static FT_Memory nmemory(long struct) {
        return FT_Memory.createSafe(memGetAddress(struct + FT_Face.MEMORY));
    }
    ...
    public static FT_Stream nstream$(long struct) {
        return FT_Stream.createSafe(memGetAddress(struct + FT_Face.STREAM));
    }

    public static FT_List nsizes_list(long struct) {
        return FT_List.create(struct + FT_Face.SIZES_LIST);
    }

    public static FT_Generic nautohint(long struct) {
        return FT_Generic.create(struct + FT_Face.AUTOHINT);
    }

    public static long nextensions(long struct) {
        return memGetAddress(struct + FT_Face.EXTENSIONS);
    }

    public static long ninternal(long struct) {
        return memGetAddress(struct + FT_Face.INTERNAL);
    }
