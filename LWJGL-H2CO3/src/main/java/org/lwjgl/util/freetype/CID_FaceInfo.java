...
public class CID_FaceInfo extends Struct<CID_FaceInfo> {
    ...
    public static ByteBuffer ncid_font_name(long struct) {
        return memByteBufferNT1(memGetAddress(struct + CID_FaceInfo.CID_FONT_NAME));
    }
    ...
    public static String ncid_font_nameString(long struct) {
        return memUTF8(memGetAddress(struct + CID_FaceInfo.CID_FONT_NAME));
    }
    ...
    public static long ncid_version(long struct) {
        return memGetCLong(struct + CID_FaceInfo.CID_VERSION);
    }
    ...
    public static int ncid_font_type(long struct) {
        return UNSAFE.getInt(null, struct + CID_FaceInfo.CID_FONT_TYPE);
    }
    ...
    public static ByteBuffer nregistry(long struct) {
        return memByteBufferNT1(memGetAddress(struct + CID_FaceInfo.REGISTRY));
    }
    ...
    public static String nregistryString(long struct) {
        return memUTF8(memGetAddress(struct + CID_FaceInfo.REGISTRY));
    }
    ...
    public static ByteBuffer nordering(long struct) {
        return memByteBufferNT1(memGetAddress(struct + CID_FaceInfo.ORDERING));
    }
    ...
    public static String norderingString(long struct) {
        return memUTF8(memGetAddress(struct + CID_FaceInfo.ORDERING));
    }
    ...
    public static int nsupplement(long struct) {
        return UNSAFE.getInt(null, struct + CID_FaceInfo.SUPPLEMENT);
    }
    ...
    public static PS_FontInfo nfont_info(long struct) {
        return PS_FontInfo.create(struct + CID_FaceInfo.FONT_INFO);
    }
    ...
    public static FT_BBox nfont_bbox(long struct) {
        return FT_BBox.create(struct + CID_FaceInfo.FONT_BBOX);
    }
    ...
    public static long nuid_base(long struct) {
        return memGetCLong(struct + CID_FaceInfo.UID_BASE);
    }
    ...
    public static int nnum_xuid(long struct) {
        return UNSAFE.getInt(null, struct + CID_FaceInfo.NUM_XUID);
    }
    ...
    public static CLongBuffer nxuid(long struct) {
        return memCLongBuffer(struct + CID_FaceInfo.XUID, 16);
    }
    ...
    public static long ncidmap_offset(long struct) {
        return memGetCLong(struct + CID_FaceInfo.CIDMAP_OFFSET);
    }
    ...
    public static int nfd_bytes(long struct) {
        return UNSAFE.getInt(null, struct + CID_FaceInfo.FD_BYTES);
    }
    ...
    public static int ngd_bytes(long struct) {
        return UNSAFE.getInt(null, struct + CID_FaceInfo.GD_BYTES);
    }
    ...
    public static long ncid_count(long struct) {
        return memGetCLong(struct + CID_FaceInfo.CID_COUNT);
    }
    ...
    public static int nnum_dicts(long struct) {
        return UNSAFE.getInt(null, struct + CID_FaceInfo.NUM_DICTS);
    }
    ...
    public static CID_FaceDict nfont_dicts(long struct) {
        return CID_FaceDict.create(memGetAddress(struct + CID_FaceInfo.FONT_DICTS));
    }
    ...
    public static long ndata_offset(long struct) {
        return memGetCLong(struct + CID_FaceInfo.DATA_OFFSET);
    }
    ...
    public static class Buffer extends StructBuffer<CID_FaceInfo, Buffer> {
        ...
        @NativeType("FT_ULong")
        public long xuid(int index) {
            return CID_FaceInfo.nxuid(address(), index);
        }
