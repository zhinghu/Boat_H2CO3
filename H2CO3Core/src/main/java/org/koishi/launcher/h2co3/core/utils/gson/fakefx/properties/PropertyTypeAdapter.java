 ...
 *
 * @param <I> the inner value type of the property
 * @param <P> the property type that this adapter can serialize/deserialize, containing a value of type I
 */
public abstract class PropertyTypeAdapter<I, P extends Property<? extends I>> extends TypeAdapter<P> {
     ...
     *
     * @param deserializedValue the deserialized value for the property to create. May be null.
