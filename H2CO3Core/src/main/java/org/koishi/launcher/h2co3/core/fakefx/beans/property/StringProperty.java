...
import org.koishi.launcher.h2co3.core.fakefx.beans.value.WritableStringValue;
...
public abstract class StringProperty extends ReadOnlyStringProperty implements
     ...
     * @param format the {@code Format} used to convert between this {@code StringProperty}
     *               and the other {@code Property}
     * @throws NullPointerException     if {@code other} or {@code format} is {@code null}
