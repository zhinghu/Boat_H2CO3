...
import org.koishi.launcher.h2co3.core.utils.gson.fakefx.properties.NullPropertyException;
 ...
 *
 * @param <I> the primitive type inside the property
 * @param <P> the type that this adapter can serialize/deserialize
 */
public abstract class PrimitivePropertyTypeAdapter<I, P extends Property<?>> extends TypeAdapter<P> {
     ...
     *
     * @param innerValueTypeAdapter a delegate adapter to use for the inner value of the property
     * @param throwOnNullProperty   if true, this adapter will throw {@link NullPropertyException} when given a null {@link Property} to
     *                              serialize
     * @param crashOnNullValue      if true, this adapter will throw {@link NullPrimitiveException} when reading a null value. If false, this
     ...
     *
     * @param deserializedValue the deserialized inner primitive value of the property, may not be null
