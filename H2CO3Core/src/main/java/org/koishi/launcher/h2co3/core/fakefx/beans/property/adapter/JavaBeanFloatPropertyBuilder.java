...
/**
 * A {@code JavaBeanFloatPropertyBuilder} can be used to create
 * {@link JavaBeanFloatProperty JavaBeanFloatProperties}. To create
 * a {@code JavaBeanFloatProperty} one first has to call {@link #create()}
 ...
 * of the same class, you can reuse a {@code JavaBeanFloatPropertyBuilder}
...
public final class JavaBeanFloatPropertyBuilder {
    ...
    /**
     * Generates a new {@link JavaBeanFloatProperty} with the current settings.
     *
