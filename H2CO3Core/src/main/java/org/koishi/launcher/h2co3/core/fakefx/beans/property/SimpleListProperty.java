...
public class SimpleListProperty<E> extends ListPropertyBase<E> {
     ...
     * The constructor of {@code SimpleListProperty}
     *
     * @param bean the bean of this {@code SetProperty}
     * @param name the name of this {@code SetProperty}
     */
     ...
     * The constructor of {@code SimpleListProperty}
     *
     * @param bean         the bean of this {@code ListProperty}
     * @param name         the name of this {@code ListProperty}
     * @param initialValue the initial value of the wrapped value
     */
