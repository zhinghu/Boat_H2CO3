...
import org.koishi.launcher.h2co3.core.fakefx.property.adapter.JavaBeanPropertyBuilderHelper;
import org.koishi.launcher.h2co3.core.fakefx.property.adapter.PropertyDescriptor;

import java.lang.reflect.Method;

/**
 * A {@code JavaBeanDoublePropertyBuilder} can be used to create
 * {@link JavaBeanDoubleProperty JavaBeanDoubleProperties}. To create
 * a {@code JavaBeanDoubleProperty} one first has to call {@link #create()}
 ...
 * of the same class, you can reuse a {@code JavaBeanDoublePropertyBuilder}
...
public final class JavaBeanDoublePropertyBuilder {
    ...
    /**
     * Generates a new {@link JavaBeanDoubleProperty} with the current settings.
     *
